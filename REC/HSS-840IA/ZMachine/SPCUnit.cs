...
namespace Machine
{
    ...
    public struct TLotData
    {
        ...
        public string Barcode         ; //밖에서세팅. 랏속에 작업한 트레이들 리스트.
        ...
        //public int    WorkCnt1       ;//밖에서세팅.
        //public int    WorkCnt2       ;//밖에서세팅.
    ...
    public class CLot : DataHandler<TLotData>
    {
        ...
        public void DispLotInfo(ListView _lvLotInfo) //오퍼레이션 창용.
        {
            ...
            //SttTime
            _lvLotInfo.Items[1].SubItems[0].Text = "SttTime  ";
            tDateTime = DateTime.FromOADate(Data.StartedAt);
            _lvLotInfo.Items[1].SubItems[1].Text = tDateTime.ToString("HH:mm:ss");

            //EndTime
            _lvLotInfo.Items[2].SubItems[0].Text = "EndTime  ";
            tDateTime = DateTime.FromOADate(Data.EndedAt);
            _lvLotInfo.Items[2].SubItems[1].Text = tDateTime.ToString("HH:mm:ss");

            //RunTime
            _lvLotInfo.Items[3].SubItems[0].Text = "RunTime";
            Span = TimeSpan.FromMilliseconds(Data.RunTime);
            _lvLotInfo.Items[3].SubItems[1].Text = Span.ToString(@"hh\:mm\:ss");//, System.Globalization.CultureInfo.InvariantCulture);

            //DownTime
            _lvLotInfo.Items[4].SubItems[0].Text = "DownTime";
            Span = TimeSpan.FromMilliseconds(Data.DownTime);
            _lvLotInfo.Items[4].SubItems[1].Text = Span.ToString(@"hh\:mm\:ss");//, System.Globalization.CultureInfo.InvariantCulture);

            //IdleTime
            _lvLotInfo.Items[5].SubItems[0].Text = "IdleTime";
            Span = TimeSpan.FromMilliseconds(Data.IdleTime);
            _lvLotInfo.Items[5].SubItems[1].Text = Span.ToString(@"hh\:mm\:ss");//, System.Globalization.CultureInfo.InvariantCulture);

            //FailureTime
            _lvLotInfo.Items[6].SubItems[0].Text = "FailureTime";
            tDateTime = DateTime.FromOADate(Data.FailureTime);
            _lvLotInfo.Items[6].SubItems[1].Text = tDateTime.ToString("HH:mm:ss");

            //Cycletime
            tDateTime = DateTime.FromOADate(SEQ.XRYD.dCycleTime);
            _lvLotInfo.Items[7].SubItems[0].Text = "CycleTime";
            _lvLotInfo.Items[7].SubItems[1].Text = tDateTime.ToString("mm:ss");
    ...
    public class CFailure :DataHandler<TFailureData>
    {
        ...
        public void Update(string _sCrntId , string _sCrntLotNo , EN_SEQ_STAT Stat , bool _bMaint)
        {
            if(bFirst) {
                bPreFailer = _bMaint ;
                bFirst = false ;
    ...
    public static class SPC
    {
        ...
        public static void Update(string _sCrntId , string _sCrntLotNo , string _sCrntDev , EN_SEQ_STAT Stat , bool _bMaint)
        {
            ERR.Update(_sCrntLotNo,Stat);
            LOT.Update(_sCrntLotNo,Stat , _sCrntDev , _bMaint);
            FLR.Update(_sCrntId , _sCrntLotNo,Stat , _bMaint);
        }
    }
}
