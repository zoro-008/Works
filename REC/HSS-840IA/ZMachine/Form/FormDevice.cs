...
namespace Machine
{
    public partial class FormDevice : Form
    {
        ...
        private void btSetting_Click(object sender, EventArgs e)    //DeviceSet Form 띄움
        {
            ...
            FrmMain.FrmDeviceSet.UpdateLsv(true);
            FrmMain.FrmDeviceSet.UpdateEzSensor(true);
            FrmMain.FrmDeviceSet.EzToDressyChange();
            PM.UpdatePstn(true);
        ...
        private void btDownload_Click(object sender, EventArgs e)             //HRM-930B 참고
        {
            ...
            SEQ.XRYD.iWorkStep = 0;
            SEQ.XRYE.iWorkStep = 0;
