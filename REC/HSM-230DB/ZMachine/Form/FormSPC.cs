...
namespace Machine
{
    public partial class FormSPC : Form
    {
        ...
        public FormSPC(Panel _pnBase)
        {
            ...
            dpWrkSttTime.Value = DateTime.Now;
            dpWrkEndTime.Value = DateTime.Now;
        ...
        public void DispDateList()
        {
            ...
            //ListView Display
            DirectoryInfo Info = new DirectoryInfo(SPC.LOT.LOT_FOLDER);
            if (Info.Exists)
            {
        ...
        public void DispMgzAndSlotList(string _sDate , string _sLotId , ListView _lvMgz , ListView _lvSlot )
        {
            ...
            string sPath = SPC.LOT.LOT_FOLDER + _sDate + "\\" + _sLotId + ".ini";
        ...
        public void DispStripMap(string _sDate , string _sLotId , int _iMgz , int _iSlot , ListView _lvMap)
        {
            ...
            sPath = SPC.LOT.LOT_FOLDER + _sDate + "//" + _sLotId + ".ini" ;
        ...
        private void btWorkDataView_Click(object sender, EventArgs e)
        {
            SPC.WRK.DispData(dpWrkSttTime.Value, dpWrkEndTime.Value, lvWrkData);
        }
    }
}
