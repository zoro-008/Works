...
namespace Machine
{
    public partial class FraOutput : Form
    {
        ...
        private void tmUpdate_Tick(object sender, EventArgs e)
        {
            ...
            bool bOut = SML.IO.GetY((int)m_iYadd, false);
        ...
        {
            SML.IO.SetY((int)m_iYadd, !SML.IO.GetY((int)m_iYadd));

            string sMsg;
            sMsg = lbTitle.Text + " Button Click " + (SML.IO.GetY((int)m_iYadd) ? "(ON)" : "(OFF)").ToString();
