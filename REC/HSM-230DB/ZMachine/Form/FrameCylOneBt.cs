...
namespace Machine
{
    public partial class FraCylOneBt : Form
    {
        ...
        public void SetConfig(ci _iActrId, string _sTitle, EN_MOVE_DIRECTION _iActrType, Control _wcParent /*, dgCheckSafe _CheckSafe*/)
        {
            ...
            if ((int)SML.CL.GetCmd((int)m_iActrId) == 0) { btAction.ImageIndex = iFwd; btAction.Text = sFwd; }
        ...
        private void tmUpdate_Tick(object sender, EventArgs e)
        {
            ...
            bool bCmd  = SML.CL.GetCmd  ((int)m_iActrId) == 0 ? true : false;
            bool bErr  = SML.CL.Err     ((int)m_iActrId);
            bool bDone = SML.CL.Complete((int)m_iActrId);
        ...
        private void btAction_Click(object sender, EventArgs e)
        {
            ...
            if (SML.CL.GetCmd((int)m_iActrId) == 0) sCylderPos = EN_CYLINDER_POS.Fwd;
            else                                   sCylderPos = EN_CYLINDER_POS.Bwd;
