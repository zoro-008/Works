...
namespace EraeMotionApi
{
   public class EMCL
   {
      ...
      ************************************************************************/
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_ResetAlarm(int nPortNum, byte nModuleId, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_ResetPosError(int nPortNum, byte nModuleId, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_ResetError(int nPortNum, byte nModuleId, Int32 nErrorType, ref Int32 nRetValue);	// 1:alarm, 4: pos Err,  5: all
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetServoOn(int nPortNum, byte nModuleId, Int32 nOnOff, ref Int32 nRetValue);
