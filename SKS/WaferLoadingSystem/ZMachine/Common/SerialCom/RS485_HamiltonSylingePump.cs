...
20 170 35.5 40 10 600.0
    ...
    public class RS485_HamiltonSylingePump
    {
        ...
        public RS485_HamiltonSylingePump(int _iPortId , string _sName , int _iMaxPumpCnt=1)
        {           
            iPortId    = _iPortId   ;
            sName      = _sName     ;
        ...
        private void DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            try
            {
                ...
                bBusy[iLastSendedAdd] = (Status & 0x20) == 0;
        ...
        //}
        public bool MoveAbs(int _iAdd , VALVE_POS _eV , int _iPos , int _iSpdCode = 0 )
        {
            string sCmd = "" ;
        ...
        public bool DispInc(int _iAdd , VALVE_POS _eV , int _iPos , int _iSpdCode = 0 )
        {
            string sCmd = "" ;
        ...
        public bool SuckInc(int _iAdd , VALVE_POS _eV , int _iPos , int _iSpdCode = 0 )
        {
            string sCmd = "" ;
        ...
        public bool SuckAndDispInc(int _iAdd , VALVE_POS _eVSuck , VALVE_POS _eVDisp , int _iPos , int _iSpdCode = 0 )
        {
            string sCmd = "" ;
            ...
            if(_eVSuck == VALVE_POS.Input)
            {
                sCmd +="I";
            }
            else if(_eVSuck == VALVE_POS.Output)
            {
                sCmd +="O";
            }
            else if(_eVSuck == VALVE_POS.Bypass)
            {
                sCmd +="B";
            }
            else
