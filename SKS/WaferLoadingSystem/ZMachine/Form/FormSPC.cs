...
namespace Machine
{
    public partial class FormSPC : Form
    {
        ...
        //FormSPC_Sub FrmSPC_Sub = new FormSPC_Sub();
        ...
        public FormSPC(Panel _pnBase)
        {
            ...
            tcData.TabPages.Remove(metroTabPage4);
            tcData.TabPages.Remove(metroTabPage3);
        ...
        private void FormSPC_Load(object sender, EventArgs e)
        {
            //pnLot.Left = 0 ;
            //pnLot.Top  = 0 ;
            //pnLot.Dock = DockStyle.None ;
            //
            //pnErr.Left   = 0 ;
            //pnErr.Top    = 0 ;
            //pnErr.Dock = DockStyle.None ;
        }
...
//            SPC.LOT.Data.RunTime       = 
        ...
        private void FormSPC_VisibleChanged(object sender, EventArgs e)
        {
            ...
            if (this.Visible) btDataView_Click(sender , e);
            //FrmSPC_Sub.Hide();
        }
        ...
        {
                 if(tcData.SelectedIndex == 0) pnUptime.Text = string.Format("UPTIME={0:0.000}%",GetLotUptime()) ;
            else if(tcData.SelectedIndex == 1) pnUptime.Text = string.Format("MTBA={0:0.000}min",GetMTBA()) + " " + string.Format("MTTA={0:0.000}sec",GetMTTA()) ;
            else if(tcData.SelectedIndex == 2) pnUptime.Text = string.Format("MTBF={0:0.000}hour",GetMTBF()) + " " + string.Format("MTTR={0:0.000}min" ,GetMTTR()) ;
            else pnUptime.Text = "";
