...
namespace MotionInterface
{
    ...
    public interface IMotor
    {
        ...
        /// <param name="_dDec">이동할 감속 펄스단위</param>
        /// <returns>성공여부</returns>
        void GoRel(double _dPos, double _dVel, double _dAcc, double _dDec);  //Relativity move
        ...
        /// <param name="_bActual">엔코더기준인지 커멘드 기준인지</param>
        /// <param name="_bOnLevel">트리거 레벨</param>
        void SetTrgAbs(double _dPos, bool _bMethod, double _dTrgTime, bool _bActual, bool _bOnLevel);
        /// <summary>
