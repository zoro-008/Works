...
namespace Machine
{
    public class ML
    {
        ...
        static public bool              CL_Move      (ci   _eCylNo, fb _eCmd)                { if(SEQ.CheckSafe(    _eCylNo, _eCmd) != "") return false; return SM.CYL.Move    ((int)_eCylNo, (EN_CYL_POS)_eCmd); }
        static public bool              CL_Move      (int  _eCylNo, fb _eCmd)                { if(SEQ.CheckSafe((ci)_eCylNo, _eCmd) != "") return false; return SM.CYL.Move    ((int)_eCylNo, (EN_CYL_POS)_eCmd); }
        static public bool              CL_Move      (uint _eCylNo, fb _eCmd)                { if(SEQ.CheckSafe((ci)_eCylNo, _eCmd) != "") return false; return SM.CYL.Move    ((int)_eCylNo, (EN_CYL_POS)_eCmd); }
        ...
        //static public double       RotationToPulse    (mi   _eMotrNo, double _dRotation)                    {return SM.MTR.RotationToPulse ((int)_eMotrNo, _dRotation)             ;}
        //static public double       RotationToPulse    (int  _eMotrNo, double _dRotation)                    {return SM.MTR.RotationToPulse ((int)_eMotrNo, _dRotation)             ;}
        //static public double       RotationToPulse    (uint _eMotrNo, double _dRotation)                    {return SM.MTR.RotationToPulse ((int)_eMotrNo, _dRotation)             ;}
        //
        //
        //static public double       UnitToPulse        (mi   _eMotrNo, double _dUnit)                        {return SM.MTR.UnitToPulse     ((int)_eMotrNo, _dUnit)                 ;}
        //static public double       UnitToPulse        (int  _eMotrNo, double _dUnit)                        {return SM.MTR.UnitToPulse     ((int)_eMotrNo, _dUnit)                 ;}
        //static public double       UnitToPulse        (uint _eMotrNo, double _dUnit)                        {return SM.MTR.UnitToPulse     ((int)_eMotrNo, _dUnit)                 ;}
        //
        //static public double       PulseToUnit        (mi   _eMotrNo, double _dPulse)                       {return SM.MTR.PulseToUnit     ((int)_eMotrNo, _dPulse)                ;}
        //static public double       PulseToUnit        (int  _eMotrNo, double _dPulse)                       {return SM.MTR.PulseToUnit     ((int)_eMotrNo, _dPulse)                ;}
        //static public double       PulseToUnit        (uint _eMotrNo, double _dPulse)                       {return SM.MTR.PulseToUnit     ((int)_eMotrNo, _dPulse)                ;}

        static public double       MT_GetUnitPerRev   (mi   _iMotrNo)                                       {return SM.MTR.GetUnitPerRev   ((int)_iMotrNo)                         ;}
        static public double       MT_GetUnitPerRev   (int  _iMotrNo)                                       {return SM.MTR.GetUnitPerRev   ((int)_iMotrNo)                         ;}
        static public double       MT_GetUnitPerRev   (uint _iMotrNo)                                       {return SM.MTR.GetUnitPerRev   ((int)_iMotrNo)                         ;}
        ...
        static public bool         MT_GoHome          (mi   _eMotrNo)                                       { if(SEQ.CheckSafe(    _eMotrNo) != "") return false;return SM.MTR.GoHome          ((int)_eMotrNo)                         ;}
        static public bool         MT_GoHome          (int  _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return false;return SM.MTR.GoHome          ((int)_eMotrNo)                         ;}
        static public bool         MT_GoHome          (uint _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return false;return SM.MTR.GoHome          ((int)_eMotrNo)                         ;}
        ...
        static public void         MT_JogP            (mi   _eMotrNo)                                       { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.JogP            ((int)_eMotrNo)                         ;}
        static public void         MT_JogP            (int  _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.JogP            ((int)_eMotrNo)                         ;}
        static public void         MT_JogP            (uint _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.JogP            ((int)_eMotrNo)                         ;}

        static public void         MT_JogN            (mi   _eMotrNo)                                       { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.JogN            ((int)_eMotrNo)                         ;}
        static public void         MT_JogN            (int  _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.JogN            ((int)_eMotrNo)                         ;}
        static public void         MT_JogN            (uint _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.JogN            ((int)_eMotrNo)                         ;}

        static public void         MT_JogVel          (mi   _eMotrNo, double _dVel)                         { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.JogVel          ((int)_eMotrNo, _dVel)                  ;}
        static public void         MT_JogVel          (int  _eMotrNo, double _dVel)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.JogVel          ((int)_eMotrNo, _dVel)                  ;}
        static public void         MT_JogVel          (uint _eMotrNo, double _dVel)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.JogVel          ((int)_eMotrNo, _dVel)                  ;}

        static public void         MT_JogAbs          (mi _eMotrNo  , double _dVel,
                                                                      double _dAcc, double _dDec) { if (SEQ.CheckSafe(_eMotrNo)     != "") return; SM.MTR.JogAbs((int)_eMotrNo, _dVel, _dAcc, _dDec); }
        static public void         MT_JogAbs          (int _eMotrNo , double _dVel,
                                                                      double _dAcc, double _dDec) { if (SEQ.CheckSafe((mi)_eMotrNo) != "") return; SM.MTR.JogAbs((int)_eMotrNo, _dVel, _dAcc, _dDec); }
        ...
        static public void         MT_GoAbs           (mi   _eMotrNo, double _dPos, double _dVel, 
                                                                      double _dAcc, double _dDec)           { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoAbs           ((int)_eMotrNo, _dPos , _dVel , _dAcc , _dDec);}
        static public void         MT_GoAbs           (int  _eMotrNo, double _dPos, double _dVel, 
                                                                      double _dAcc, double _dDec)           { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbs           ((int)_eMotrNo, _dPos , _dVel , _dAcc , _dDec);}
        static public void         MT_GoAbs           (uint _eMotrNo, double _dPos, double _dVel, 
                                                                      double _dAcc, double _dDec)           { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbs           ((int)_eMotrNo, _dPos , _dVel , _dAcc , _dDec);}

        static public void         MT_GoAbsVel        (mi   _eMotrNo, double _dPos, double _dVel)           { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoAbsVel        ((int)_eMotrNo, _dPos , _dVel )         ;}
        static public void         MT_GoAbsVel        (int  _eMotrNo, double _dPos, double _dVel)           { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbsVel        ((int)_eMotrNo, _dPos , _dVel )         ;}
        static public void         MT_GoAbsVel        (uint _eMotrNo, double _dPos, double _dVel)           { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbsVel        ((int)_eMotrNo, _dPos , _dVel )         ;}

        static public void         MT_GoAbsRun        (mi   _eMotrNo, double _dPos, int    _iPer = 0)       { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoAbsRun        ((int)_eMotrNo, _dPos , _iPer )         ;}
        static public void         MT_GoAbsRun        (int  _eMotrNo, double _dPos, int    _iPer = 0)       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbsRun        ((int)_eMotrNo, _dPos , _iPer )         ;}
        static public void         MT_GoAbsRun        (uint _eMotrNo, double _dPos, int    _iPer = 0)       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbsRun        ((int)_eMotrNo, _dPos , _iPer )         ;}

        static public void         MT_GoAbsMan        (mi   _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoAbsMan        ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoAbsMan        (int  _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbsMan        ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoAbsMan        (uint _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbsMan        ((int)_eMotrNo, _dPos         )         ;}

        static public void         MT_GoAbsSlow       (mi   _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoAbsSlow       ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoAbsSlow       (int  _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbsSlow       ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoAbsSlow       (uint _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoAbsSlow       ((int)_eMotrNo, _dPos         )         ;}
                                                          
        static public void         MT_GoInc           (mi   _eMotrNo, double _dPos, double _dVel, 
                                                                      double _dAcc, double _dDec)           { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoInc           ((int)_eMotrNo, _dPos , _dVel , _dAcc , _dDec);}
        ...
        static public void         MT_GoIncVel        (mi   _eMotrNo, double _dPos, double _dVel)           { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoIncVel        ((int)_eMotrNo, _dPos , _dVel )         ;}
        static public void         MT_GoIncVel        (int  _eMotrNo, double _dPos, double _dVel)           { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoIncVel        ((int)_eMotrNo, _dPos , _dVel )         ;}
        static public void         MT_GoIncVel        (uint _eMotrNo, double _dPos, double _dVel)           { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoIncVel        ((int)_eMotrNo, _dPos , _dVel )         ;}

        static public void         MT_GoIncRun        (mi   _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoIncRun        ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoIncRun        (int  _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoIncRun        ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoIncRun        (uint _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoIncRun        ((int)_eMotrNo, _dPos         )         ;}

        static public void         MT_GoIncMan        (mi   _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoIncMan        ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoIncMan        (int  _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoIncMan        ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoIncMan        (uint _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoIncMan        ((int)_eMotrNo, _dPos         )         ;}

        static public void         MT_GoIncSlow       (mi   _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe(    _eMotrNo) != "") return;      SM.MTR.GoIncSlow       ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoIncSlow       (int  _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoIncSlow       ((int)_eMotrNo, _dPos         )         ;}
        static public void         MT_GoIncSlow       (uint _eMotrNo, double _dPos)                         { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.GoIncSlow       ((int)_eMotrNo, _dPos         )         ;}
        ...
        static public void         MT_Repeat          (mi   _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.StartRepeat((int)_eMotrNo);}
        static public void         MT_Repeat          (int  _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.StartRepeat((int)_eMotrNo);}
        static public void         MT_Repeat          (uint _eMotrNo)                                       { if(SEQ.CheckSafe((mi)_eMotrNo) != "") return;      SM.MTR.StartRepeat((int)_eMotrNo);}
        //포지션 관련 랩핑.                               
        ...
        static public void         MT_SetTrgAbs       (mi   _eMotrNo, bool _bMethod, double _dPos, double _dTrgTime, bool _bActual, bool _bOnLevel) {  SM.MTR.SetTrgAbs((int)_eMotrNo, _bMethod, _dPos, _dTrgTime, _bActual, _bOnLevel);}
        static public void         MT_SetTrgAbs       (int  _eMotrNo, bool _bMethod, double _dPos, double _dTrgTime, bool _bActual, bool _bOnLevel) {  SM.MTR.SetTrgAbs((int)_eMotrNo, _bMethod, _dPos, _dTrgTime, _bActual, _bOnLevel);}
        static public void         MT_SetTrgAbs       (uint _eMotrNo, bool _bMethod, double _dPos, double _dTrgTime, bool _bActual, bool _bOnLevel) {  SM.MTR.SetTrgAbs((int)_eMotrNo, _bMethod, _dPos, _dTrgTime, _bActual, _bOnLevel);}
