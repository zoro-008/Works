...
namespace Machine
{
    ...
    public sealed class SEQ
    {
        ...
        private static void UpdateButton  ()
        {
            ...
            if(bManualSw)
            {
                if(m_bRun || bDoorOpen1 || bDoorOpen2) ML.ER_SetErr(ei.ETC_Manual , "Can not change to manual mode" );
                else                                   ML.IO_SetY(yi.PowerAuto,false);
            }
            if(bAutoSw)
            {
                ML.IO_SetY(yi.PowerAuto,true);
            }
