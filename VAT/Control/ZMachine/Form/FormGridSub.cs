...
namespace Machine
{
    public partial class FormGridSub : Form
    {
        ...
        private void InitGridView()
        {
            ...
            gvPara.Columns.Add(clGMode      ); gvPara.Columns[10].Width = 75 ;
            gvPara.Columns.Add(clGStartKV   ); gvPara.Columns[11].Width = 65 ;
            gvPara.Columns.Add(clGStopKV    ); gvPara.Columns[12].Width = 65 ;
            gvPara.Columns.Add(clGStepKV    ); gvPara.Columns[13].Width = 65 ;
            gvPara.Columns.Add(clGStepTime  ); gvPara.Columns[14].Width = 65 ;
            gvPara.Columns.Add(clGKeepA     ); gvPara.Columns[15].Width = 65 ;
            gvPara.Columns.Add(clGEndA      ); gvPara.Columns[16].Width = 65 ;
                                                              
            gvPara.Columns.Add(clFMode      ); gvPara.Columns[17].Width = 75 ;
            gvPara.Columns.Add(clFStartKV   ); gvPara.Columns[18].Width = 65 ;
            gvPara.Columns.Add(clFStopKV    ); gvPara.Columns[19].Width = 65 ;
            gvPara.Columns.Add(clFStepKV    ); gvPara.Columns[20].Width = 65 ;
            gvPara.Columns.Add(clFStepTime  ); gvPara.Columns[21].Width = 65 ;
            //gvPara.Columns.Add(clFKeepA     ); gvPara.Columns[22].Width = 65 ;
            //gvPara.Columns.Add(clFEndA      ); gvPara.Columns[23].Width = 65 ;
                                                              
            gvPara.Columns.Add(clCMode      ); gvPara.Columns[22].Width = 75 ;
            gvPara.Columns.Add(clCOnTime    ); gvPara.Columns[23].Width = 50 ;
            gvPara.Columns.Add(clCOffTime   ); gvPara.Columns[24].Width = 50 ;
                                                              
            gvPara.Columns.Add(clCLMin      ); gvPara.Columns[25].Width = 50 ;
            gvPara.Columns.Add(clCLMax      ); gvPara.Columns[26].Width = 50 ;
        ...
        private void btSave_Click(object sender, EventArgs e)
        {
            ...
            int iNo = CConfig.StrToIntDef(cbNo.Text,0);
            SetList(iNo);
            
            SEQ.aging.ListLogSub();
        ...
        {
            iNo = CConfig.StrToIntDef(cbNo.Text,0);
            tbName.Text = GetName(iNo);

            string sDevInfoPath = System.AppDomain.CurrentDomain.BaseDirectory + "Util\\" + iNo.ToString() + ".csv";

            if(!File.Exists(sDevInfoPath)) OM.SeasoningOptnViewSub.Rows.Clear();
            else                           OM.SeasoningOptnViewSub.Load(sDevInfoPath);
