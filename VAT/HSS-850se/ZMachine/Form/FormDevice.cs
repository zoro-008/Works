...
namespace Machine
{
    public partial class FormDevice : Form
    {
        ...
        public FormDevice(FormMain _FrmMain)
        {
            ...
            //Form DeviceSet Setting
            FrmDeviceSet = new FormDeviceSet(pnDevSet);
            FrmDeviceSet.TopLevel = false   ;
            FrmDeviceSet.Parent   = pnDevSet;
            FrmDeviceSet.Dock     = DockStyle.Fill;
            FrmDeviceSet.Show();
        ...
        {
            string sPath;
            sPath = Application.StartupPath + "\\Recipe\\";
            ...
            if (Info.Exists)
            {
                ...
                //lvDevice.Columns.Add("NAME", 370, HorizontalAlignment.Left);
                lvDevice.Columns.Add("NAME", 670, HorizontalAlignment.Left);
                lvDevice.Columns.Add("MODIFIED DATE", 210, HorizontalAlignment.Left);
        ...
        private void btDownload_Click(object sender, EventArgs e)             //HRM-930B 참고
        {
            ...
            //
            //string sDevInfoPath = System.AppDomain.CurrentDomain.BaseDirectory + "JobFile\\" + OM.GetCrntDev() + "\\RecipeRead.csv";
            //데이터 그리드뷰 불러와서 셋팅하기
            //FrmMain.FrmDeviceSet.RecipeSetting();
            //FormDeviceSet.RecipeSetting();
            ...
            string sDevOptnPath = sExeFolder + "Recipe\\" + sName + "\\TrayMask.ini";
        ...
        private void btNew_Click(object sender, EventArgs e)
        {
            ...
            string sPath;
            sPath = Application.StartupPath + "\\Recipe\\" + tbToName.Text;
            ...
            string sPathInfo = Application.StartupPath + "\\Recipe\\";
        ...
        private void btCopy_Click(object sender, EventArgs e)
        {
            ...
            string sFromPath;
            string sToPath;
            sFromPath = Application.StartupPath + "\\Recipe\\" + tbFromName.Text;
            sToPath = Application.StartupPath + "\\Recipe\\" + tbToName.Text;
        ...
        private void btDelete_Click(object sender, EventArgs e)
        {
            ...
            sPath = Application.StartupPath + "\\Recipe\\" + tbFromName.Text;
        ...
        private void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                if(!LOT.LotOpened) FrmDeviceSet.RecipeSetting();
