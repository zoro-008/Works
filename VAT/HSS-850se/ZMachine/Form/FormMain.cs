...
namespace Machine
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            //lbName.Text = OM.EqpOptn.sEquipName; //Eqp.sEqpName;
        ...
        private void tmUpdate_Tick(object sender, EventArgs e)
        {
            ...
            if (NowStat != m_iPreStat && NowStat == EN_SEQ_STAT.Running && !Eqp.bIgnrCam)
            {
                ...
                string sPath = @"D:\CameraRec\" + System.DateTime.Now.ToString("yyyyMMdd") + @"\" +  
                               System.DateTime.Now.ToString("hh.mm.ss(") + LOT.GetLotNo() + ").avi";
        ...
        private void pnOptn1_Paint(object sender, PaintEventArgs e)
        {
