...
namespace Machine
{
    public class DispensePattern
    {
        ...
        public void Load(string _sDevName)
        {
            ...
            sPath = sExeFolder + "Recipe\\" + _sDevName + "\\DispensePattern.pat";
        ...
        {
            string sExeFolder = System.AppDomain.CurrentDomain.BaseDirectory;
            string sPttColorPath = sExeFolder + "Recipe\\" + _sJobName + "\\DispenseColor.ini";
    ...
    public class HeightPattern
    {
        ...
        public void Load(string _sDevName)
        {
            ...
            sPath = sExeFolder + "Recipe\\" + _sDevName + "\\HeightPattern.pat";
        ...
        {
            string sExeFolder = System.AppDomain.CurrentDomain.BaseDirectory;
            string sPttColorPath = sExeFolder + "Recipe\\" + _sJobName + "\\HeightColor.ini";
