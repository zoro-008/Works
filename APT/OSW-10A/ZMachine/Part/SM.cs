...
namespace Machine
{
    public class SM
    {
        ...
        static public EN_ERR_LEVEL ER_GetErrLevel (ei _eErr                                                                                                           ){return SML.ER.GetErrLevel ((int)_eErr);}
        static public int          ER_GetLastErr  (                                                                                                                   ){return SML.ER.GetLastErr  (          );}
        static public string       ER_GetErrName  (ei _eErr                                                                                                           ){return SML.ER.GetErrName  ((int)_eErr);}
        static public void         ER_SetNeedShowErr  (bool _bDisp                                                                                                        ){       SML.ER.SetNeedShowErr(_bDisp    );}
        ...
        static public bool         MT_GetHoming       (mi _eMotrNo)                                       {return SML.MT.GetHoming       ((int)_eMotrNo)                         ;}
