...
namespace SML2
{
    ...
    public partial class FormDllMain: Form //UserControl
    {
        ...
        private void InitTabErr()
        {
            ...
            if(SML.ER._iMaxErrCnt >0)lvError.Items[0].Selected = true ;
        ...
        private void InitTabDio()
        {
            ...
            lvInput.Columns.Add("NotLog"  , 55 ,HorizontalAlignment.Left);
            ...
            if(SML.IO._iMaxIn >0)lvInput.Items[0].Selected = true ;
            ...
            lvOutput.Columns.Add("NotLog"  , 55 , HorizontalAlignment.Left);
            ...
            if(SML.IO._iMaxOut >0)lvOutput.Items[0].Selected = true ;
        }
        ...
        private void InitTabCylinder()
        {
            ...
            if(SML.CL._iMaxCylinder >0)lvCylinder.Items[0].Selected = true ;
        ...
        private void tmUpdate_Tick(object sender, EventArgs e)
        {
            ...
            {
                if(m_iPreCrntLevel != SML.FrmLogOn.GetLevel())  DispMotr();
        ...
        private void DispErrProp(int _iSelNo)
        {
            ...
            if(SML.ER.GetErrLevel(_iSelNo) == EN_ERR_LEVEL.Error) rbError.Checked = true;
        ...
        private void DispDio()
        {
            for (int i = 0; i < SML.IO._iMaxIn; i++)
            {
                ...
                lvInput.Items[i].SubItems[7 ].Text = SML.IO.GetInputPara(i).bNotLog ? "O" : "X";
                lvInput.Items[i].SubItems[8 ].Text = SML.IO.GetInputPara(i).SComt;
                lvInput.Items[i].SubItems[9 ].Text = string.Format("{0:0}", SML.IO.GetInputPara(i).iOnDelay);
                lvInput.Items[i].SubItems[10].Text = string.Format("{0:0}", SML.IO.GetInputPara(i).iOffDelay);
            }
            ...
            for (int i = 0; i < SML.IO._iMaxOut; i++)
            {
                ...
                lvOutput.Items[i].SubItems[7 ].Text = SML.IO.GetOutputPara(i).bNotLog ? "O" : "X";
                lvOutput.Items[i].SubItems[8 ].Text = SML.IO.GetOutputPara(i).SComt;
                lvOutput.Items[i].SubItems[9 ].Text = string.Format("{0:0}", SML.IO.GetOutputPara(i).iOnDelay);
                lvOutput.Items[i].SubItems[10].Text = string.Format("{0:0}", SML.IO.GetOutputPara(i).iOffDelay);
            }
        }
        ...
        private void DispDioInputProp(int _iSelNo)
        {
            ...
            cbNotLog.Checked   = SML.IO.GetInputPara(_iSelNo).bNotLog;
        }
        ...
        private void DispDioOutputProp(int _iSelNo)
        {
            ...
            cbNotLog.Checked   = SML.IO.GetOutputPara(_iSelNo).bNotLog;
        }
        ...
        private void DispMotr()
        {
            ...
            if (SML.FrmLogOn.GetLevel() >= EN_LEVEL.Master)
            {
            ...
            m_iPreCrntLevel = SML.FrmLogOn.GetLevel();
            
        }

        private void DispMotrAll(bool _bToTable)
        {
            if (_bToTable)
            {
                CConfig.ValToCon(tbSpeedRatioAllMotr     , ref SML.MT.ParaAll.SpeedRatioAll    );                
            }
            else
            {
                CConfig.ConToVal(tbSpeedRatioAllMotr     , ref SML.MT.ParaAll.SpeedRatioAll    );
                if(SML.MT.ParaAll.SpeedRatioAll == 0)SML.MT.ParaAll.SpeedRatioAll = 100 ;
                if(SML.MT.ParaAll.SpeedRatioAll < 10)SML.MT.ParaAll.SpeedRatioAll = 10  ;
                if(SML.MT.ParaAll.SpeedRatioAll >100)SML.MT.ParaAll.SpeedRatioAll = 100 ;
