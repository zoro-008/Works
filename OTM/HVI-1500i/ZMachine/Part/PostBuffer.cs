    ...
    public class PostBuffer : Part
    {
        ...
        override public bool ToStart() //스타트를 하기 위한 함수.
        {
            ...
            switch (Step.iToStart)
            {
                ...
                case 10:
                    if (OM.EqpStat.iCrntMrkPenUsage >= OM.CmnOptn.iPenMaxUsage)
                    {
                        ER_SetErr(ei.PSTB_MrkPenMaxUsage, "Marking pen usage exceeded.");
                        return true;
                    }
        ...
        public bool CycleWork()
        {
            ...
            switch (Step.iCycle)
            {
                ...
                case 20: //위에서 사용
                    ...
                    //마킹펜 사용량 초과 에러
                    //if(iCrntMrkPenUsage >= OM.CmnOptn.iPenMaxUsage)
                    //{
                    //    ER_SetErr(ei.PSTB_MrkPenMaxUsage, "Marking pen usage exceeded.");
                    //    return true;
                    //}
