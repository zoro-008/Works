    ...
    public partial class FraMotr : Form
    {
        ...
        private void btNeg_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (!OM.MstOptn.bDebugMode)
            {
                ...
                if (m_eId == mi.HEAD_YVisn) bRet = SEQ.VSNZ.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.PSTB_XMark) bRet = SEQ.PSTB.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.PSTB_YMark) bRet = SEQ.PSTB.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.HEAD_XCvr1) bRet = SEQ.VSNZ.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.HEAD_XCvr2) bRet = SEQ.VSNZ.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.HEAD_XCvr3) bRet = SEQ.VSNZ.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.LODR_YClmp) bRet = SEQ.LODR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.LODR_ZClmp) bRet = SEQ.LODR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.ULDR_YClmp) bRet = SEQ.ULDR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.ULDR_ZClmp) bRet = SEQ.ULDR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
        ...
        private void btPos_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (!OM.MstOptn.bDebugMode)
            {
                ...
                if (m_eId == mi.HEAD_YVisn) bRet = SEQ.VSNZ.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.PSTB_XMark) bRet = SEQ.PSTB.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.PSTB_YMark) bRet = SEQ.PSTB.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.HEAD_XCvr1) bRet = SEQ.VSNZ.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.HEAD_XCvr2) bRet = SEQ.VSNZ.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.HEAD_XCvr3) bRet = SEQ.VSNZ.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.LODR_YClmp) bRet = SEQ.LODR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.LODR_ZClmp) bRet = SEQ.LODR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.ULDR_YClmp) bRet = SEQ.ULDR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.ULDR_ZClmp) bRet = SEQ.ULDR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
