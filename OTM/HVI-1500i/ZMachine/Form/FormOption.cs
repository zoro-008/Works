    ...
    public partial class FormOption : Form
    {
        ...
        {                                                                                   
            if (_bToTable == true) 
            {
                ...
                CConfig.ValToCon(tbPenMaxUsage , ref OM.CmnOptn.iPenMaxUsage);
            ...
            else 
            {
                ...
                CConfig.ConToVal(tbPenMaxUsage , ref OM.CmnOptn.iPenMaxUsage);
        ...
        {
            tbCrntPenCnt.Text = OM.EqpStat.iCrntMrkPenUsage.ToString();
        ...
        {
            if(Log.ShowMessageModal("Warning", "Are you sure you want to reset the current number of marking pen Count?") != DialogResult.Yes) return;
            OM.EqpStat.iCrntMrkPenUsage = 0;
        }
    }
}
