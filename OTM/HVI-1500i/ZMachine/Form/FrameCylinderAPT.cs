    ...
    public partial class FrameCylinderAPT : Form
    {
        ...
        private void evFwd_Click(object sender, EventArgs e)
        {
            ...
            if (SEQ.LODR.CheckSafe(m_iActrId, fb.Fwd , true) && 
                SEQ.PREB.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.VSNZ.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.PSTB.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.ULDR.CheckSafe(m_iActrId, fb.Fwd , true)) ML.CL_Move(m_iActrId, fb.Fwd);
        }
        ...
        private void evBwd_Click(object sender, EventArgs e)
        {
            ...
            if (SEQ.LODR.CheckSafe(m_iActrId, fb.Bwd , true) &&
                ...
                SEQ.VSNZ.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.PSTB.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.ULDR.CheckSafe(m_iActrId, fb.Bwd , true)) ML.CL_Move(m_iActrId, fb.Bwd);
