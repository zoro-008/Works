...
namespace Machine
{
    public partial class FormOperation : Form
    {
        ...
        private void tmUpdate_Tick(object sender, EventArgs e)
        {
            ...
            lbMrkPenLimit.Text = "Marking pen using limit :" + OM.CmnOptn.iPenMaxUsage.ToString();
            lbCrntMrkPenCnt.Text = "Current number using a marking pen :" + OM.EqpStat.iCrntMrkPenUsage.ToString();
