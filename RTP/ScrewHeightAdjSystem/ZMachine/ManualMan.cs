...
namespace Machine
{
    class MM
    {
        ...
        public static bool SetManCycle(mc _iNo)
        {
            ...
            bool bPartHome = mc.ADJ_CycleHome == _iNo ;
            ...
            if (m_iManNo == mc.NoneCycle) { }
                ...
                SEQ.ADJ.InitHomeStep();

            }

            else if (m_iManNo == mc.ADJ_CycleHome     ) { SEQ.ADJ.InitHomeStep ();}

            else if (m_iManNo == mc.CycleRun          ) { SEQ.ADJ.InitCycleRun      ();}
            else if (m_iManNo == mc.TableTurn         ) { SEQ.ADJ.InitCycleStep     ();}
            else if (m_iManNo == mc.PreCheck          ) { SEQ.ADJ.InitCyclePreCheck ();}
            else if (m_iManNo == mc.Adjust            ) { SEQ.ADJ.InitCycleAdjust   ();}
            else if (m_iManNo == mc.PostCheck         ) { SEQ.ADJ.InitCyclePostCheck();}

            else if (m_iManNo == mc.NutCylUp          ) {                         }
            else if (m_iManNo == mc.NutCylDown        ) { SEQ.ADJ.InitCycleStep();}
            else if (m_iManNo == mc.NutStart          ) { SEQ.ADJ.InitCycleStep();}
            else if (m_iManNo == mc.NutStop           ) { SEQ.ADJ.InitCycleStep();}
        ...
        public static void Update()
        {
            ...
            else if (m_iManNo == mc.ADJ_CycleHome        ) { if (SEQ.ADJ.CycleHome         ()) m_iManNo = mc.NoneCycle; }
            ...
            else if (m_iManNo == mc.CycleRun           ) { if( SEQ.ADJ.CycleRun            ()) m_iManNo = mc.NoneCycle; }     
            else if (m_iManNo == mc.TableTurn          ) { if( SEQ.ADJ.CycleTableTurn      ()) m_iManNo = mc.NoneCycle; }     
            else if (m_iManNo == mc.PreCheck           ) { if( SEQ.ADJ.CyclePreCheck       ()) m_iManNo = mc.NoneCycle; }
            else if (m_iManNo == mc.Adjust             ) { if( SEQ.ADJ.CycleAdjust         ()) m_iManNo = mc.NoneCycle; }
            else if (m_iManNo == mc.PostCheck          ) { if( SEQ.ADJ.CyclePostCheck      ()) m_iManNo = mc.NoneCycle; }
            
            else if (m_iManNo == mc.NutCylUp           ) { if( SEQ.ADJ.MoveCyl             (ci.ADJ_AdjustUpDn, fb.Fwd)) m_iManNo = mc.NoneCycle; }
            else if (m_iManNo == mc.NutCylDown         ) { if( SEQ.ADJ.CycleNutCylDown     ()) m_iManNo = mc.NoneCycle; }
            else if (m_iManNo == mc.NutStart           ) { if( SEQ.ADJ.CycleNutStart       ()) m_iManNo = mc.NoneCycle; }
            else if (m_iManNo == mc.NutStop            ) { if( SEQ.ADJ.CycleNutStop        ()) m_iManNo = mc.NoneCycle; }
        ...
        public static bool CheckStatus(int iId = -1)
        {
            ...
            //
            //bool bDisp1 = !bPckNone && !ML.IO_GetX(xi.WaferVacuum) ;
            //bool bUnkn1 =  bPckNone &&  ML.IO_GetX(xi.WaferVacuum) ;
            //
