...
namespace Machine
{
    public partial class FormMaster : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            tbReadData.Text = SEQ.rsNut.sData.dData.ToString();

            tbLeft1.Text = SEQ.rsHeight.sHeight.dLeft1.ToString();
            tbLeft2.Text = SEQ.rsHeight.sHeight.dLeft2.ToString();
            tbRight1.Text = SEQ.rsHeight.sHeight.dRight1.ToString();
            tbRight2.Text = SEQ.rsHeight.sHeight.dRight2.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //ML.MT_OneShotTrg(mi.HEAD_XVisn , true, iOneshotTime);
        ...
        {
            if(!int.TryParse(tbVisnId.Text , out int iVisnID)) return ;
            //SEQ.VSNZ.VisnComs[iVisnID].SendCmd(VisnCom.vc.LotStart , tbLotNo.Text);
        ...
        {
            if(!int.TryParse(tbVisnId.Text , out int iVisnID)) return ;
            //SEQ.VSNZ.VisnComs[iVisnID].SendCmd(VisnCom.vc.JobChange , tbJobChange.Text);
        }

        private void button8_Click(object sender, EventArgs e)
        {
            if(!int.TryParse(tbVisnId.Text , out int iVisnID)) return ;
            //SEQ.VSNZ.VisnComs[iVisnID].SendCmd(VisnCom.vc.Reset , tbJobChange.Text);
        }
        ...
        private void button10_Click(object sender, EventArgs e)
        {
            int iTemp1 = 0;
            int iTemp2 = 0;
            int.TryParse(tbCode.Text, out iTemp1);
            int.TryParse(tbData.Text, out iTemp2);
            SEQ.rsNut.SendWrite(iTemp1, iTemp2);
        }
        ...
        private void button16_Click(object sender, EventArgs e)
        {
            ...
            switch (iTag)
            {
                case 0: ML.IO_SetY(yi.HSensorStart, true); break;
                case 1: ML.IO_SetY(yi.HSensorClear, !ML.IO_GetY(yi.HSensorClear)); break;
                case 2: ML.IO_SetY(yi.HSensorZero , !ML.IO_GetY(yi.HSensorZero )); break;
            }

            
        }

        private void btCylUp_Click(object sender, EventArgs e)
        {
            int iTag = Convert.ToInt32(((Button)sender).Tag);

            switch (iTag)
            {
                case 0: MM.SetManCycle(mc.NutCylUp  ); break;
                case 1: MM.SetManCycle(mc.NutCylDown); break;
            }
        }
    }
}
