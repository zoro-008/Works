...
namespace Machine
{
    public partial class FormMain : Form
    {
        ...
        EN_SEQ_STAT ePreStat = EN_SEQ_STAT.Stop ;
        private void tmUpdate_Tick(object sender, EventArgs e)
        {
            ...
            //if (SEQ.ADJ.bShowResult)
            //{
            //    SEQ.ADJ.bShowResult = false;
            //
            //    if(!DM.ARAY[ri.STT].CheckAllStat(cs.None))
            //    {
            //             if (DM.ARAY[ri.STT].CheckAllStat(cs.Good)) FrmOkNg.SetResult(0);
            //        else if (DM.ARAY[ri.STT].CheckAllStat(cs.NG1 )) FrmOkNg.SetResult(1, DM.ARAY[ri.STT].Data.sResultNg);
            //        else                                            FrmOkNg.SetResult(2, DM.ARAY[ri.STT].Data.sResultNg);
            //
            //        FrmOkNg.Show();
            //    }       
            //    
            //}
            //if(FrmOkNg.Visible && SEQ._iSeqStat != ePreStat && SEQ._iSeqStat == EN_SEQ_STAT.Running)
            //{
            //    FrmOkNg.Hide();
            //}
            ePreStat = SEQ._iSeqStat;
