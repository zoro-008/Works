...
namespace COMMON
{
    ...
    {
        long m_lPreTickTime;
        bool m_bUsing = false ; //타임아웃에서 신경 쓰고 싶지 안하서 만듬.
        public void Clear()
        {
            m_lPreTickTime = System.DateTime.Now.Ticks;
        }
        ...
        public bool GetUsing(bool _bClear = true)
        {
            bool bRet = m_bUsing ;
            if(_bClear)m_bUsing = false ;
    ...
    /// </summary>
    public sealed class CMultimidiaTimer : IComponent
    {
        ...
        /// </param>
        public CMultimidiaTimer(IContainer container)
        {
            ///
