...
namespace COMMON
{
    ...
    public class CSerialPort
    {
        ...
        public void Load(SerialPort _Port , string _sPath = "")
        {
            ...
            Ini.Load(sTitle, "BaudRate ", ref iBaudRate ); if(iBaudRate  ==0)iBaudRate  = 9600 ;
            Ini.Load(sTitle, "DataBit  ", ref iDataBit  ); if(iDataBit<5 || iDataBit>8)iDataBit   = 8 ;
            Ini.Load(sTitle, "ParityBit", ref iParityBit); 
            Ini.Load(sTitle, "StopBit  ", ref iStopBit  ); if(iStopBit<1 || iStopBit>3)iStopBit   = 1 ;
