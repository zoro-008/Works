...
namespace SMDll2
{
    public partial class FormPassword : Form
    {
        ...
        public void ShowPage(EN_LEVEL _iSelLevel)
        {
            ...
            if (m_iSelLevel == EN_LEVEL.lvEngineer) lbInputPass.Text = "[ENGINEER] Input Password";
            if (m_iSelLevel == EN_LEVEL.lvMaster  ) lbInputPass.Text = "[MASTER] Input Password"  ;
        }
        ...
        private void btEnter_Click(object sender, EventArgs e)    //Password Check
        {
            if(m_iCurrentMode == 0)
            {
                if(m_iSelLevel == EN_LEVEL.lvEngineer)
                {
                ...
                else if (m_iSelLevel == EN_LEVEL.lvMaster)
                {
