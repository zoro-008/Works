...
namespace Machine
{
    ...
    public delegate bool FCheckSafeJog(mi _iAxis, bool _bPos);
    ...
    public partial class FraMotr : Form
    {
        ...
        public FCheckSafeJog CheckSafeJog = null;
        ...
        public void SetCheckSafeJog(FCheckSafeJog _fCheckSafeJog)
        {
            CheckSafeJog = new FCheckSafeJog( _fCheckSafeJog);
        }
        ...
        private void btNeg_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if(CheckSafeJog != null)
            {
                if(!CheckSafeJog((mi)m_iId , false))
                {
                    return;
                }
            }
