...

{
    ...
    public delegate bool   dgCheckSafe(mi m ,double v);
    ...
    public class MotrPstn
    {
        ...
        private void btGoClick(object sender, EventArgs e)
		{
            ...
            if (CheckSafe != null)
            {
                if (!CheckSafe((mi)m_uMotrId, uPstnNo))
                {
    ...
    public static class PM
    {
        ...
        public static uint[] PstnCnt = { (uint)pv.MAX_PSTN_MOTR0, (uint)pv.MAX_PSTN_MOTR1, (uint)pv.MAX_PSTN_MOTR2, (uint)pv.MAX_PSTN_MOTR3, (uint)pv.MAX_PSTN_MOTR4, (uint)pv.MAX_PSTN_MOTR5 };
