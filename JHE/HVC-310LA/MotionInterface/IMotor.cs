...
namespace MotionInterface
{
    ...
    public interface IMotor
    {
        ...
        bool GoHome(double _dHomeVelFirst , double _dHomeVelLast , double _dHomeAccFirst, double _dMinPosPulse, double _dMaxPosPulse);
        /// <summary>
        /// 홈동작 완료 확인.
        /// </summary>
        ...
        void SetTrgPos  (double [] _dPos , double _dTrgTime , bool _bActual ,bool _bOnLevel);    //Target Actual Position or Command Position.
        /// <summary>
        ...
        /// <summary>
        /// 모터메이커별 특수 파라메터 세팅으로 모터별로 파라미터 이름이 달라서 
        /// </summary>
        /// <returns></returns>
        void SetDoublePara(string _sParaName , double _dValue);

        /// <summary>
        /// 모터메이커별 특수 파라메터 세팅으로 모터별로 파라미터 이름이 달라서 
        /// </summary>
        /// <returns></returns>
        int GetIntStat(string _sStatName);
