...
namespace MotionInterface
{
    ...
    public interface IMotor
    {
        ...
        /// <param name="_bOnLevel">트리거 레벨</param>
        void SetTrgBlock(double _dStt, double _dEnd, double _dPeriod, double _dTrgTime=0, bool _bActual=false, bool _bOnLevel=false);
        /// <summary>
        ...
        void OneShotTrg(bool _bOnLevel=false, int _iTime=0);
        ...
        /// </summary>
        bool SetLinkEnable(int _iSlvMotrNo=0);
