...
{    
    ...
    {
        private  CParaMotorAxl Para      = new CParaMotorAxl() ;
        ...
        public void ApplyPara(double _dPulsePerUnit)
        {
            ...
            if(Para.bGantryEnable) SetLinkEnable (Para.iGantrySubAdd);
            else                   SetLinkDisable(Para.iGantrySubAdd);
        ...
        public bool SetLinkEnable(int _iSlvMotrNo)
        {
            ...
            if(uiRet == (int)AXT_FUNC_RESULT.AXT_RT_SUCCESS) return true;
            return false;
        }
        ...
        public bool GetLinkMode()
        {
            ...
            if (uiGantryOn == (int)AXT_USE.ENABLE) return true;
            return false;
        }
