...
namespace Script
{
    ...
    class Motor_Move : ParserFunction
    {
        ...
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            if(!Constants.CHECK) SM.MTR.GoAbsRun((int)arg1,arg2);
    ...
    class Motor_MovePos : ParserFunction
    {
        ...
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            if(!Constants.CHECK) SM.MTR.GoAbsRun((int)arg1,dPos);
    ...
    class Motor_CheckStop : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            var list = Utils.GetFunctionArgs(data, ref from, ParaCnt);
            uint.TryParse(list[0],out uint arg1);
            bool bRet = SM.MTR.GetStopInpos((int)arg1);
    ...
    class Motor_CheckStopPos : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            uint.TryParse(list[0],out uint arg1);
            uint.TryParse(list[1],out uint arg2);
            bool bRet  = false;//TODO ::SM.MTR.GetStopInpos((int)arg1,(pv)arg2);
    ...
    class Motor_Stop : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            var list = Utils.GetFunctionArgs(data, ref from, ParaCnt);
            uint.TryParse(list[0],out uint arg1);
            if(!Constants.CHECK) SM.MTR.GetStopInpos((int)arg1);
    ...
    class Motor_Servo : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            uint.TryParse(list[0],out uint arg1);
            uint.TryParse(list[1],out uint arg2);
            if(!Constants.CHECK) SM.MTR.SetServo((int)arg1,arg2 == 1 ? true:false);
    ...
    class Motor_Home : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            var list = Utils.GetFunctionArgs(data, ref from, ParaCnt);
            uint.TryParse(list[0],out uint arg1);
            if(!Constants.CHECK) SM.MTR.GoHome((int)arg1);
    ...
    class Motor_CheckHome : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            var list = Utils.GetFunctionArgs(data, ref from, ParaCnt);
            uint.TryParse(list[0],out uint arg1);
            bool bRet  = SM.MTR.GetHomeDone((int)arg1);
    ...
    class Cylinder_Move : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            uint.TryParse(list[0],out uint arg1);
            uint.TryParse(list[1],out uint arg2);
            if(!Constants.CHECK) SM.CYL.Move((int)arg1,(EN_CYL_POS)arg2);
    ...
    class Cylinder_CheckStop : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            uint.TryParse(list[0],out uint arg1);
            uint.TryParse(list[1],out uint arg2);
            bool bRet = SM.CYL.Complete((int)arg1,(EN_CYL_POS)arg2);
    ...
    class IO_SetY : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            ...
            uint.TryParse(list[0],out uint arg1);
            uint.TryParse(list[1],out uint arg2);
            if(!Constants.CHECK) SM.DIO.SetY((int)arg1,arg2 == 1);
    ...
    class IO_GetY : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            var list = Utils.GetFunctionArgs(data, ref from, ParaCnt);
            uint.TryParse(list[0],out uint arg1);
            bool bRet = SM.DIO.GetY((int)arg1);
    ...
    class IO_GetX : ParserFunction
    {
        protected override Parser.Result Evaluate(string data, ref int from)
        {
            var list = Utils.GetFunctionArgs(data, ref from, ParaCnt);
            uint.TryParse(list[0],out uint arg1);
            bool bRet = SM.DIO.GetX((int)arg1);
