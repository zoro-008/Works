...
namespace Machine
{
    ...
    public static class OM
    {
        ...
        {   //device에 대한 Dev_Info
            ...
            public double[]  dInfo     ; //Using Script
            //public string[]  sInfo     ; //Using Script
        } ;                                 
       ...
       //=========================================================
        ...
        public static void Init()
        {
            ...
            //Using Script
            DevInfo.dInfo         = new double[Constants.OPTION_DEVICE_MAX];
            //DevInfo.sInfo         = new string[Constants.OPTION_DEVICE_MAX];
            CmnOptn.dInfo         = new double[Constants.OPTION_COMMON_MAX];
            //CmnOptn.sInfo         = new string[Constants.OPTION_COMMON_MAX];
