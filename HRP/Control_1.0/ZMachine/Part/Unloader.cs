...
namespace Machine
{
    ...
    public class Unloader : Part
    {
        ...
        override public void Update()
        {
            ...
            if (DM.ARAY[ri.PSHR].CheckAllStat(cs.Good) && iPshrCycle == 0) iPshrCycle = 10;
            if (DM.ARAY[ri.PSHR].CheckAllStat(cs.Good) && iPshrCycle != 0 && OM.DevInfo.iWorkEndCnt > OM.EqpStat.iULDRCnt) CyclePusher();
        ...
        override public bool Autorun() //오토런닝시에 계속 타는 함수.
        {
            ...
            switch (Step.eSeq)
            {
                ...
                case sc.Plce    : if (!CyclePlce ()) return false; break;
                case sc.Paint   : if (!CyclePaint()) return false; break;
        ...
        public bool CyclePusher()
        {
            ...
            {
                sTemp = string.Format("Cycle Step.iCycle={0:00}", iPshrCycle);
                sTemp = m_sPartName + sTemp;
                ER_SetErr(ei.PRT_CycleTO, sTemp);
                Trace(sTemp);
                return true;
            ...
            switch (iPshrCycle)
            {
                ...
                case 11:
                    if (!CL_Complete(ci.ULDR_OutPshrFwBw, fb.Fwd))
                    {
                        MoveCyl(ci.ULDR_OutPshrFwBw, fb.Fwd);
                        return false;
                    }
        ...
        public bool CyclePaint()
        {
            ...
            switch (Step.iCycle)
            {
                ...
                case 10:
                    ...
                    MoveMotr(mi.ULDR_XNzzl, pv.ULDR_XNzzlWorkStt);
                    MoveCyl(ci.ULDR_OutPshrFwBw, fb.Fwd);
                    Step.iCycle++;
                    return false;
                ...
                case 11:
                    ...
                    if (!MT_GetStopPos(mi.ULDR_XNzzl, pv.ULDR_XNzzlWorkStt)) return false;
                    ...
                    MoveMotr(mi.ULDR_XNzzl, pv.ULDR_XNzzlWorkEnd);
                    Step.iCycle++;
                    return false;

                case 12:
                    if (!MT_GetStopPos(mi.ULDR_XNzzl, pv.ULDR_XNzzlWorkEnd)) return false;
