    ...
    public partial class FrameCylinderAPT : Form
    {
        ...
        public void SetConfig(ci _iActrId, string _sTitle, EN_MOVE_DIRECTION _iActrType, Control _wcParent /*, dgCheckSafe _CheckSafe*/)
        {
            ...
            switch (m_iType)
            {
                ...
                case EN_MOVE_DIRECTION.FB: sBwd = "FWD"   ; btBwd.Click += new EventHandler(evBwd_Click);
        ...
        private void evFwd_Click(object sender, EventArgs e)
        {
            string sText = ((Button)sender).Text;
            Log.Trace(m_sActrName, sText + " Button Clicked",ti.Frm);
            if(SEQ.LODR.CheckSafe(m_iActrId , fb.Fwd , true) && 
               SEQ.TTBL.CheckSafe(m_iActrId , fb.Fwd , true) && 
               SEQ.VISN.CheckSafe(m_iActrId , fb.Fwd , true) && 
               SEQ.MARK.CheckSafe(m_iActrId , fb.Fwd , true) && 
               SEQ.ULDR.CheckSafe(m_iActrId , fb.Fwd , true) && 
               SEQ.REJM.CheckSafe(m_iActrId , fb.Fwd , true) && 
               SEQ.REJV.CheckSafe(m_iActrId , fb.Fwd , true)) ML.CL_Move(m_iActrId, fb.Fwd);
        }
        ...
        private void evBwd_Click(object sender, EventArgs e)
        {
            ...
            if (SEQ.LODR.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.TTBL.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.VISN.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.MARK.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.ULDR.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.REJM.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.REJV.CheckSafe(m_iActrId, fb.Bwd , true)) ML.CL_Move(m_iActrId, fb.Bwd);
