    ...
    class HUD
    {
	    ...
	    private void UpdateTextureText() {
	    	...
	    	using (Graphics gfx = Graphics.FromImage(textBMP)) {
	    		...
	    		gfx.DrawString("MouseX="+current.X.ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
                gfx.DrawString("MouseY="+current.Y.ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
                //int[] viewport = new int[4];
                //Matrix4 modelViewMatrix, projectionMatrix;
                //GL.GetFloat(GetPName.ModelviewMatrix, out modelViewMatrix);
                //GL.GetFloat(GetPName.ProjectionMatrix, out projectionMatrix);
                //GL.GetInteger(GetPName.Viewport, viewport);
                //gfx.DrawString("ModelviewMatrixX="+modelViewMatrix..ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
                //gfx.DrawString("ModelviewMatrixY="+modelViewMatrix..ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
                //gfx.DrawString("ModelviewMatrixZ="+modelViewMatrix..ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));

                //gfx.DrawString("ProjectionMatrix="+ProjectionMatrix.X.ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
                //gfx.DrawString("ProjectionMatrix="+ProjectionMatrix.Y.ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
                //gfx.DrawString("ProjectionMatrix="+ProjectionMatrix.Y.ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));

                //gfx.DrawString("viewport="+viewport.X.ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
                //gfx.DrawString("viewport="+viewport.Y.ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
                //gfx.DrawString("viewport="+viewport.Y.ToString(), TextFont, drawBrush, new PointF(0, line++ * TextFont.Height));
