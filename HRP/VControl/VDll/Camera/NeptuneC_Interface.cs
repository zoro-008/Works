...
namespace NeptuneC_Interface
{
    ...
    class NeptuneC
    {
        const string sDllPath = "NeptuneC64_4109\\NeptuneC_MD_VC80.dll" ;//".\\NeptuneC_MD_VC80.dll" ;
        ///////////////////////////////////////////////////////////////////////
        //
        ...
        [DllImport(sDllPath, CallingConvention = CallingConvention.StdCall)]
        ...
        [DllImport(".\\NeptuneC_ND_VC80.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern ENeptuneError ntcSetCameraListOpt(ENeptuneCameraListOpt eCameraListOpt);

        //NEPTUNE_C_API ENeptuneError API_CALLTYPE ntcGetCameraListOpt(ENeptuneCameraListOpt * peCameraListOpt);
        [DllImport(".\\NeptuneC_ND_VC80.dll", CallingConvention = CallingConvention.StdCall)]
        public static extern ENeptuneError ntcGetCameraListOpt(ref ENeptuneCameraListOpt peCameraListOpt);
