...
namespace COMMON
{
    public static class CFolderMaker
    {
        /// <summary>
        ...
        public static bool MakeFilePathFolder(string _sFileName)
        {
            ...
            return MakeFolder(sFileFolderPath) ;

            //DirectoryInfo diPath = new DirectoryInfo(sFileFolderPath);
            //
        ...
        public static bool MakeFolder(string _sFolderName)
        {
        
            if(_sFolderName == null )return false ;            
            DirectoryInfo diPath = new DirectoryInfo(_sFolderName);
        ...
        //public static bool Copy(string _sSrc, string _sDst ) 
        //{  
        //    if(!CopyFile(_sSrc, _sDst)) return false ; 
        //    if(!CopyDirectory(_sSrc, _sDst)) return false ;
        //    return true ;
        //   
        //} 
        //public static bool CopyFile(string _sSrc, string _sDst ) 
        //{ 
        //    DirectoryInfo diSrc = new DirectoryInfo(_sSrc); 
        //    DirectoryInfo diDst = new DirectoryInfo(_sDst); 
        //    
        //    FileInfo[] files = diSrc.GetFiles(); 
        //    string fullPath = diDst.FullName; 
        //    foreach (FileInfo file in files) 
        //    file.CopyTo(fullPath + "\\" + file.Name); 
        //    
        //    return true ;
        //} 
        //public static bool CopyDirectory(string _sSrc, string _sDst ) 
        //{ 
        //    DirectoryInfo diSrc = new DirectoryInfo(_sSrc); 
        //    DirectoryInfo diDst = new DirectoryInfo(_sDst); 
        //    
        //    DirectoryInfo[] diSrcs = diSrc.GetDirectories(); 
        //    foreach (DirectoryInfo sdir in diSrcs) 
        //    { 
        //       DirectoryInfo ddir = Directory.CreateDirectory(diDst.FullName + "\\" + sdir.Name); 
        //       Copy(sdir.FullName, diDst.FullName + "\\" + sdir.Name); 
        //    } 
        //    
        //    return true ;
        //} 
        //
        //public static bool RenameDirectory(String _sSrcDir, String _sDstDir)
        //{
        //    try
        //    {
        //        DirectoryInfo dInfo = new DirectoryInfo(_sSrcDir);
        //        dInfo.MoveTo(_sDstDir);
        //       
        //    }
        //    catch (Exception ex)
        //    {
