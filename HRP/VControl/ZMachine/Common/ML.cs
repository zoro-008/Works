...
namespace Machine
{
    public class ML
    {
        ...
        static public void         MT_SetY            (mi   _eMotrNo, uint _iY , bool _bOn)                 {       SM.MTR.SetY            ((int)_eMotrNo, (int)_iY , _bOn  );}
        static public void         MT_SetY            (int  _eMotrNo, uint _iY , bool _bOn)                 {       SM.MTR.SetY            ((int)_eMotrNo, (int)_iY , _bOn  );}
        static public void         MT_SetY            (uint _eMotrNo, uint _iY , bool _bOn)                 {       SM.MTR.SetY            ((int)_eMotrNo, (int)_iY , _bOn  );}
