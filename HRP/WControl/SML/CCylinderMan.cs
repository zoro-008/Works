...
namespace SML
{
    ...
    public class CCylinderMan//========================================================================================================================
    {
        ...
        //WPF용 Status
        public void WpfDisplayStatus(int _iActrNo , System.Windows.Controls.DockPanel _lbFwdStat , System.Windows.Controls.DockPanel _lbBwdStat , System.Windows.Controls.DockPanel _lbAlarm)
        {
            //Check Null.
            if ((_lbFwdStat == null) || (_lbBwdStat == null) || (_lbAlarm == null)) return;
        
            //Display.
            if (m_aCylinder[_iActrNo].Complete(EN_CYL_POS.Fwd)) _lbFwdStat .Background = System.Windows.Media.Brushes.Lime;
            else                                                _lbFwdStat .Background = System.Windows.Media.Brushes.Gray;
            if (m_aCylinder[_iActrNo].Complete(EN_CYL_POS.Bwd)) _lbBwdStat .Background = System.Windows.Media.Brushes.Lime;
            else                                                _lbBwdStat .Background = System.Windows.Media.Brushes.Gray;
            if(m_aCylinder[_iActrNo].Para.iFwdXAdd != -1 || m_aCylinder[_iActrNo].Para.iBwdXAdd != -1 /*|| 
               m_aCylinder[_iActrNo].Para.iFwdYAdd != -1 || m_aCylinder[_iActrNo].Para.iBwdYAdd != -1*/)
            {
                if (m_aCylinder[_iActrNo].Err()                          ) _lbAlarm   .Background = System.Windows.Media.Brushes.Red ;
                else                                                       _lbAlarm   .Background = System.Windows.Media.Brushes.Gray;
            }
        }
