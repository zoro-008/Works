...
namespace SML
{
    ...
    public class SM
    {
        ...
        public static View.LogOn FrmLogOn;
        ...
        public static void SetDllMainWin(Panel _ctBase) 
        {
            /*
            if (_ctBase != null)//판떼기에 붙일때
            {
                FrmDllMain.TopLevel = false;
                FrmDllMain.FormBorderStyle = FormBorderStyle.None;
                _ctBase.Controls.Add(FrmDllMain);
                FrmDllMain.Dock = DockStyle.Fill;
            }
            else//그냥띠울때.
            {
                FrmDllMain.TopLevel = true;
                FrmDllMain.FormBorderStyle = FormBorderStyle.FixedToolWindow;
                FrmDllMain.StartPosition = FormStartPosition.CenterParent ; 
                //_ctBase.Controls.Add(FrmDllMain);
                //FrmDllMain.Dock = DockStyle.Fill;
            }
