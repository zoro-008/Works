...
namespace Machine
{
    public class ML
    {
        ...
        //포지션 관련 랩핑.                               
        //TODO :: static public void         MT_GoAbsRun        (mi   _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsRun        ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: static public void         MT_GoAbsRun        (int  _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsRun        ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: static public void         MT_GoAbsRun        (uint _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsRun        ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: 
        //TODO :: static public void         MT_GoAbsMan        (mi   _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsMan        ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: static public void         MT_GoAbsMan        (int  _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsMan        ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: static public void         MT_GoAbsMan        (uint _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsMan        ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: 
        //TODO :: static public void         MT_GoAbsSlow       (mi   _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsSlow       ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: static public void         MT_GoAbsSlow       (int  _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsSlow       ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: static public void         MT_GoAbsSlow       (uint _eMotrNo, pv _ePos)                             {       SM.MTR.GoAbsSlow       ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        ...
        //TODO :: static public bool         MT_GetStopPos      (mi   _eMotrNo, pv _ePos ,double _dOfs=0.0)           {if(!MT_GetStop(_eMotrNo))return false ; return MT_CmprPos(_eMotrNo,(PM_GetValue(_eMotrNo , _ePos )+_dOfs)); }
        //TODO :: static public bool         MT_GetStopPos      (int  _eMotrNo, pv _ePos ,double _dOfs=0.0)           {if(!MT_GetStop(_eMotrNo))return false ; return MT_CmprPos(_eMotrNo,(PM_GetValue(_eMotrNo , _ePos )+_dOfs)); }
        //TODO :: static public bool         MT_GetStopPos      (uint _eMotrNo, pv _ePos ,double _dOfs=0.0)           {if(!MT_GetStop(_eMotrNo))return false ; return MT_CmprPos(_eMotrNo,(PM_GetValue(_eMotrNo , _ePos )+_dOfs)); }

        //TODO :: static public void         MT_SetPos          (mi   _eMotrNo, pv _ePos)                             {       SM.MTR.SetPos          ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: static public void         MT_SetPos          (int  _eMotrNo, pv _ePos)                             {       SM.MTR.SetPos          ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: static public void         MT_SetPos          (uint _eMotrNo, pv _ePos)                             {       SM.MTR.SetPos          ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ));}
        //TODO :: 
        //TODO :: static public bool         MT_CmprPos         (mi   _eMotrNo, pv _ePos, double _dRange = 0.0)       {return SM.MTR.CmprPos         ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ), _dRange )   ;}
        //TODO :: static public bool         MT_CmprPos         (int  _eMotrNo, pv _ePos, double _dRange = 0.0)       {return SM.MTR.CmprPos         ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ), _dRange )   ;}
        //TODO :: static public bool         MT_CmprPos         (uint _eMotrNo, pv _ePos, double _dRange = 0.0)       {return SM.MTR.CmprPos         ((int)_eMotrNo, PM.GetValue((uint)_eMotrNo , (uint)_ePos ), _dRange )   ;}
