...
namespace COMMON
{
	public sealed class CConfig: CDisposable //이 클래스는 마지막 클래스이므로 더 이상 상속을 할 수 없다.
    {
        ...
        public static void ValToCon(NumericUpDown _tbControl, ref int _iVal)
        {
            _tbControl.Text = _iVal.ToString();
        }
        public static void ValToCon(NumericUpDown _tbControl, ref double _dVal)
        {
            _tbControl.Text = _dVal.ToString();
        }

        public static bool ConToVal(TextBox _tbControl, ref double _dVal, double _Default = 0)
        {
            _dVal = StrToDoubleDef(_tbControl.Text, _Default);
            return true;
        }
        public static bool ConToVal(TextBox _tbControl, ref double _dVal, double _Min, double _Max, double _Default = 0)
        {
            _dVal = StrToDoubleDef(_tbControl.Text, _dVal);
                 if(_dVal < _Min) _dVal = _Min ;
            else if(_dVal > _Max) _dVal = _Max ;
            return true;
        }

        public static bool ConToVal(TextBox _tbControl, ref int _iVal, int _Default = 0)
        {
            _iVal = StrToIntDef(_tbControl.Text, _Default);
            return true;
        }
        public static bool ConToVal(TextBox _tbControl, ref int _iVal, int _Min, int _Max, int _Default = 0)
        {
            _iVal = StrToIntDef(_tbControl.Text, _Default);
                 if(_iVal < _Min) _iVal = _Min ;
            else if(_iVal > _Max) _iVal = _Max ;
            return true;
        }
        ...
        public static bool ConToVal(NumericUpDown _cbControl, ref int _Val, int _Default = 0)
        {
            _Val = StrToIntDef(_cbControl.Text, _Val);
            return true;
        }

        public static bool ConToVal(NumericUpDown _cbControl, ref int _Val, int _Min, int _Max, int _Default = 0)
        {
            _Val = StrToIntDef(_cbControl.Text, _Val);
        ...
        public static bool ConToVal(NumericUpDown _cbControl, ref double _dVal, double _Default = 0)
        {
            _dVal = StrToDoubleDef(_cbControl.Text, _Default);
            return true;
        }

        public static bool ConToVal(NumericUpDown _cbControl, ref double _dVal, double _Min, double _Max, double _Default = 0)
        {
            _dVal = StrToDoubleDef(_cbControl.Text, _dVal);
                 if(_dVal < _Min) _dVal = _Min ;
            else if(_dVal > _Max) _dVal = _Max ;
            return true;
        }

        //WPF용 옵션 Setting & Display
        //Win Form에서는 System.Windows.Forms 참조한 컨트롤 사용
        //WPF에서는 System.Windows.Controls 참조한 컨트롤 사용하여 WPF용으로 하나 더 만든다.

        public static void ValToCon(System.Windows.Controls.TextBox _tbControl, ref double _dVal)
        {
            _tbControl.Text = _dVal.ToString();
        }

        public static void ValToCon(System.Windows.Controls.TextBox _tbControl, ref int _iVal)
        {
            _tbControl.Text = _iVal.ToString();
        }
        public static void ValToCon(System.Windows.Controls.TextBox _tbControl, ref string _sVal)
        {
            _tbControl.Text = _sVal;
        }

        public static void ValToCon(System.Windows.Controls.ComboBox _cbControl, ref int _iVal)
        {
            _cbControl.SelectedIndex = _iVal;
        }

        public static void ValToCon(System.Windows.Controls.CheckBox _cbControl, ref bool _bVal)
        {
            _cbControl.IsChecked = _bVal;
        }

        public static bool ConToVal(System.Windows.Controls.TextBox _tbControl, ref double _dVal, double _Default = 0)
        {
            _dVal = StrToDoubleDef(_tbControl.Text, _Default);
            return true;
        }
        public static bool ConToVal(System.Windows.Controls.TextBox _tbControl, ref double _dVal, double _Min, double _Max, double _Default = 0)
        {
            _dVal = StrToDoubleDef(_tbControl.Text, _dVal);
                 if(_dVal < _Min) _dVal = _Min ;
            else if(_dVal > _Max) _dVal = _Max ;
        ...
        public static bool ConToVal(System.Windows.Controls.TextBox _tbControl, ref int _iVal, int _Default = 0)
        {
            _iVal = StrToIntDef(_tbControl.Text, _Default);
            return true;
        }
        public static bool ConToVal(System.Windows.Controls.TextBox _tbControl, ref int _iVal, int _Min, int _Max, int _Default = 0)
        {
            _iVal = StrToIntDef(_tbControl.Text, _Default);
                 if(_iVal < _Min) _iVal = _Min ;
            else if(_iVal > _Max) _iVal = _Max ;
        ...
        public static bool ConToVal(System.Windows.Controls.TextBox _tbControl, ref string _sVal)
        {
            if (_sVal != null)
            {
                _sVal = _tbControl.Text;
        ...
        public static bool ConToVal(System.Windows.Controls.ComboBox _cbControl, ref int _iVal)
        {
            _iVal = _cbControl.SelectedIndex;
            return true;
        }

        public static bool ConToVal(System.Windows.Controls.CheckBox _cbControl, ref bool _bVal)
        {
            _bVal = _cbControl.IsChecked == true;
            return true;
        }
