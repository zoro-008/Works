...
namespace Machine
{
    class MM
    {
        ...
        public static bool SetManCycle(mc _iNo)
        {
            ...
            else if (m_iManNo == mc.VISN_TrgOneShot   ) { }
            else if (m_iManNo == mc.MOVE_CycleMove    ) { }
            ...
            if (m_iManNo == mc.NoneCycle) { }
                ...
                SEQ.MOVE.InitHomeStep();
            }
            else if (m_iManNo == mc.VISN_TrgOneShot    ) { VL.Autorun(true); VL.Ready(0); SM.MTR.OneShotTrg((int)mi.MOVE_X, true, 28)    ; VL.Autorun(false); }
            else if (m_iManNo == mc.MOVE_CycleMove     ) {SEQ.MOVE.InitCycleStep();                        }
        ...
        public static void Update()
        {
            ...
            else if (m_iManNo == mc.VISN_TrgOneShot    ) { m_iManNo = mc.NoneCycle; }
            else if (m_iManNo == mc.MOVE_CycleMove     ) { if (SEQ.MOVE.CycleHome      ()) m_iManNo = mc.NoneCycle; }
