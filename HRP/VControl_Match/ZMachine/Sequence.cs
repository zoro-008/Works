...
namespace Machine
{
    ...
    public sealed class SEQ
    {
        ...
        static public Move MOVE = new Move((int)pi.MOVE + ti.Max);
        ...
        public static void Init()
        {
            ...
            m_Part[(int)pi.MOVE] = MOVE; //m_Part[(int)pi.LODR].SetPartId((int)pi.LODR + ti.Max);
        ...
        private static void UpdateButton()
        {
            ...
            bool bStartSw = m_bBtnStart;//ML.IO_GetXUp(xi.ETC_LStartSw) || ML.IO_GetXUp(xi.ETC_RStartSw) || m_bBtnStart;// || ML.IO_GetXUp(xi.ETC_StartSwR) || m_bBtnStart ; 
            bool bStopSw  = m_bBtnStop;//ML.IO_GetXUp(xi.ETC_LStopSw ) || ML.IO_GetXUp(xi.ETC_RStopSw ) || m_bBtnStop ;// || ML.IO_GetXUp(xi.ETC_StopSwR ) || m_bBtnStop  ; 
            bool bResetSw = m_bBtnReset;//ML.IO_GetXUp(xi.ETC_LResetSw) || ML.IO_GetXUp(xi.ETC_RResetSw) || m_bBtnReset;// || ML.IO_GetXUp(xi.ETC_ResetSwR) || m_bBtnReset ; 
            bool bAirSw = false;//ML.IO_GetXUp(xi.ETC_LAirSw  ) || ML.IO_GetXUp(xi.ETC_RAirSw  ) || m_bBtnAir ;
            bool bInitSw = false;//ML.IO_GetXUp(xi.ETC_LInitSw ) || ML.IO_GetXUp(xi.ETC_RInitSw ) ;
            ...
            //if(!m_bRun && MM.GetManNo() == mc.NoneCycle) ML.IO_SetY(yi.ETC_Manual1  , ML.IO_GetX(xi.ETC_Manual1 ));
            //if(!m_bRun && MM.GetManNo() == mc.NoneCycle) ML.IO_SetY(yi.ETC_Manual2  , ML.IO_GetX(xi.ETC_Manual2 ));
            //if(!m_bRun && MM.GetManNo() == mc.NoneCycle) ML.IO_SetY(yi.ETC_Manual3  , ML.IO_GetX(xi.ETC_Manual3 ));
            //if(!m_bRun && MM.GetManNo() == mc.NoneCycle) ML.IO_SetY(yi.ETC_Manual4  , ML.IO_GetX(xi.ETC_Manual4 ));
            //if(!m_bRun && MM.GetManNo() == mc.NoneCycle) ML.IO_SetY(yi.ETC_Manual5  , ML.IO_GetX(xi.ETC_Manual5 ));
