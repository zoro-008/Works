    ...
    public partial class FormMain : Form
    {
        ...
        private void tmUpdate_Tick(object sender, EventArgs e)
        {
            ...
            switch (SEQ._iSeqStat) {
                ...
                case EN_SEQ_STAT.Stop   : sStatText = OM.CmnOptn.bAutoQc ? "WATING FOR QC" : "STOP"    ; StatColor = (SEQ._bFlick && OM.CmnOptn.bAutoQc) ? Color.Red : Color.White ; break;
                case EN_SEQ_STAT.RunWarn: sStatText = "RUNWARN" ; StatColor = SEQ._bFlick ? Color.Gold : Color.Lime; break;
                case EN_SEQ_STAT.WorkEnd: sStatText = "LOTEND"  ; StatColor = Color.Gold; break;
            ...
            lbFcmWarning.Visible = !SEQ.FcmTester.Connected;
            lbFcmWarning.ForeColor = SEQ._bFlick ? Color.Red : Color.Yellow;

            bool bSet = false ;
             
            //장비명 표기
            OM.EqpOptn.sEquipName = "CBC TESTER II";
        ...
        {
            //Part.IO_SetY(yi.ETC_MainPumpOn, true, true);
            try 
            {
        ...
        private void lbName_MouseDoubleClick(object sender, EventArgs e)
        {
        ...
        private void tmPing_Tick(object sender, EventArgs e)
        {
            ...
            //if(!SEQ.FcmTester.RcvdMsg) return ;



            if (SEQ.FcmTester.Connected)
            {
                SEQ.FcmTester.SendPing();
                return;
            }

            SEQ.FcmTester.Connect(SEQ.sFcmIp, SEQ.iFcmPort);
        }
    }
}
