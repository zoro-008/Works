...
namespace Machine
{
    public partial class FomOption : Form
    {
        //FormMain FrmMain;
        ...
        public FomOption(Panel _pnBase)
        {
            InitializeComponent();
        ...
        {                                                                                   
            if (_bToTable == true) 
            {
                ...
                CConfig.ValToCon(cbAutoQc       , ref OM.CmnOptn.bAutoQc       );
                CConfig.ValToCon(edQcStartHour  , ref OM.CmnOptn.iQcStartHour  );
                CConfig.ValToCon(edQcStartMin   , ref OM.CmnOptn.iQcStartMin   );
                CConfig.ValToCon(edUnFreezeMin  , ref OM.CmnOptn.iUnFreezeMin  ); 
                CConfig.ValToCon(cbIgnrBarcode  , ref OM.CmnOptn.bIgnrBarcode  ); 
                CConfig.ValToCon(cbIgnrFCMTester, ref OM.CmnOptn.bIgnrFCMTester);

                CConfig.ValToCon(edVtlFCMTime   , ref OM.CmnOptn.iVtlFCMTime   );
                CConfig.ValToCon(edVtlDCTime    , ref OM.CmnOptn.iVtlDCTime    );


                CConfig.ValToCon(cbNotUseFB     , ref OM.CmnOptn.bNotUseFB     ); 
                CConfig.ValToCon(cbNotUse4DLS   , ref OM.CmnOptn.bNotUse4DLS   ); 
                CConfig.ValToCon(cbNotUseRet    , ref OM.CmnOptn.bNotUseRet    ); 
                CConfig.ValToCon(cbNotUseNr     , ref OM.CmnOptn.bNotUseNr     ); 
                
                CConfig.ValToCon(cbNotUseSpec   , ref OM.CmnOptn.bNotUseSpec   ); 
                CConfig.ValToCon(cbNotUseInsp   , ref OM.CmnOptn.bNotUseInsp   ); 

                CConfig.ValToCon(cbNotUseClean  , ref OM.CmnOptn.bNotUseClean  ); 
            ...
            else 
            {
                ...
                CConfig.ConToVal(cbAutoQc       , ref OM.CmnOptn.bAutoQc       );
                CConfig.ConToVal(edQcStartHour  , ref OM.CmnOptn.iQcStartHour  );
                CConfig.ConToVal(edQcStartMin   , ref OM.CmnOptn.iQcStartMin   );
                CConfig.ConToVal(edUnFreezeMin  , ref OM.CmnOptn.iUnFreezeMin  );

                CConfig.ConToVal(cbIgnrBarcode  , ref OM.CmnOptn.bIgnrBarcode  ); 
                CConfig.ConToVal(cbIgnrFCMTester, ref OM.CmnOptn.bIgnrFCMTester); 

                CConfig.ConToVal(edVtlFCMTime   , ref OM.CmnOptn.iVtlFCMTime   );
                CConfig.ConToVal(edVtlDCTime    , ref OM.CmnOptn.iVtlDCTime    );

                CConfig.ConToVal(cbNotUseFB     , ref OM.CmnOptn.bNotUseFB     ); 
                CConfig.ConToVal(cbNotUse4DLS   , ref OM.CmnOptn.bNotUse4DLS   ); 
                CConfig.ConToVal(cbNotUseRet    , ref OM.CmnOptn.bNotUseRet    ); 
                CConfig.ConToVal(cbNotUseNr     , ref OM.CmnOptn.bNotUseNr     ); 
                

                CConfig.ConToVal(cbNotUseSpec   , ref OM.CmnOptn.bNotUseSpec   ); 
                CConfig.ConToVal(cbNotUseInsp   , ref OM.CmnOptn.bNotUseInsp   ); 

                CConfig.ConToVal(cbNotUseClean  , ref OM.CmnOptn.bNotUseClean  ); 
                ...
                if(!PreCmnOptn.bAutoQc && OM.CmnOptn.bAutoQc )
                {
                ...
                else if(PreCmnOptn.bAutoQc && !OM.CmnOptn.bAutoQc )
                {
        ...
        {                                                                                   
            if (_bToTable == true) 
            {
                ...
                CConfig.ValToCon(tbEquipSerial  , ref OM.EqpOptn.sEquipName     );
                CConfig.ValToCon(tbEquipName    , ref OM.EqpOptn.sEquipSerial   );
            ...
            else 
            {
                ...
                CConfig.ConToVal(tbEquipSerial  , ref OM.EqpOptn.sEquipName     );
                CConfig.ConToVal(tbEquipName    , ref OM.EqpOptn.sEquipSerial   );
        ...
        private void cbAutoQc_CheckedChanged(object sender, EventArgs e)
        {
