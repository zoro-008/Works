    ...
    public partial class FraMotr : Form
    {
        ...
        private void btNeg_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (!OM.MstOptn.bDebugMode)
            {
                ...
                if (m_eId == mi.SYR_XSyrg) bRet = SEQ.SYR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.PKR_YSutl) bRet = SEQ.PKR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
            }
        ...
        private void btPos_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (!OM.MstOptn.bDebugMode)
            {
                ...
                if (m_eId == mi.SYR_XSyrg) bRet = SEQ.SYR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.PKR_YSutl) bRet = SEQ.PKR.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
