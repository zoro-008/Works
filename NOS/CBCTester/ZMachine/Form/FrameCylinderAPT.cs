...
namespace Machine
{
    public partial class FrameCylinderAPT : Form
    {
        ...
        private void evFwd_Click(object sender, EventArgs e)
        {
            string sText = ((Button)sender).Text;
            Log.Trace(m_sActrName + "_" + sText + " Button Clicked",ForContext.Frm);
            if (SEQ.LDR.CheckSafe(m_iActrId, fb.Fwd , true) && 
                SEQ.PKR.CheckSafe(m_iActrId, fb.Fwd , true) &&
                SEQ.QCB.CheckSafe(m_iActrId, fb.Fwd , true) &&
                SEQ.SYR.CheckSafe(m_iActrId, fb.Fwd , true) &&
                SEQ.CHA.CheckSafe(m_iActrId, fb.Fwd , true)) ML.CL_Move(m_iActrId, fb.Fwd);
        }
        ...
        private void evBwd_Click(object sender, EventArgs e)
        {
            ...
            if (SEQ.LDR.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.PKR.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.QCB.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.SYR.CheckSafe(m_iActrId, fb.Bwd , true) &&
                SEQ.CHA.CheckSafe(m_iActrId, fb.Bwd , true)) ML.CL_Move(m_iActrId, fb.Bwd);
