...
namespace Machine
{
    public class Eqp
    {
        ...
        public const bool   bBiosLock = true       ; //true - 실행파일 루트에 db.lock파일 및 BIOS 암호화 내용이 있어야 동작.
    }
    ...
    public enum pi : uint
    {
        LDR      = 0,
        IDX         ,
        //PCK         , 20190830 아이엠 개조로 모터 두축 들어냄.
        MAX_PART
    }
    ...
    public class ri
    {
        public const int PCK = 0; //Loader Work 1
        public const int PRI = 1; //Picker  1
        public const int MRK = 2; //Suttle. 1
        public const int BAR = 3; //Syringe 1
    ...
    public enum yi : uint
    {
        ...
        LDR_GripUp            = 16, //  yLDR_TrayZUp
        LDR_GripDn            = 17, //  yLDR_TrayZDn
