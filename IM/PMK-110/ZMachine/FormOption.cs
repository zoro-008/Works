    ...
    public partial class FormOption : Form
    {
        ...
        {                                                                                   
            if (_bToTable == true) 
            {
                ...
                cbMarkSkip   .Checked = OM.CmnOptn.bMarkSkip;
                cbBarSkip    .Checked = OM.CmnOptn.bBarSkip;
            }
            else 
            {
                OM.CmnOptn.bIgnrDoor    = cbIgnrDoor.Checked;
                OM.CmnOptn.bMarkSkip    = cbMarkSkip.Checked;
                OM.CmnOptn.bBarSkip     = cbBarSkip .Checked;
