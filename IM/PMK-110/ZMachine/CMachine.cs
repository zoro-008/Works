...
namespace Machine
{
    ...
    public sealed class SEQ
    {
        ...
        public static void Init()
        {
            ...
            Para.msAXL = EN_MOTR_SEL.msNMC2;
            Para.dsAXL = EN_DIO_SEL.dsNMC2;
        ...
        public static void Reset()
        {
         ...
         private static void UpdateButton  ()
         {
             ...
             //    MM.SetManCycle(EN_MANUAL_CYCLE.mcAllHome);
             //}
             ...
             { 
                 ...
                 //Log.Trace("MM.GetManNo()", string.Format(MM.GetManNo().ToString()));
             }
             if (bStopSw)
             {
                 Log.Trace("Stop", "Stop");
             ...
             //{
             //    if(StopBtn.OnDelay(SM.IO.GetX((int)xi.xETC_StopSw)||SM.IO.GetX((int)xi.xETC_StopSw) , 5000))
             //    {
             ...
             switch (m_iStep) {
                 ...
                 case EN_SEQ_STEP.scToStartCon : if(!ToStartCon()) return ;
                                                 ...
                                                 if (DM.ARAY[(int)ri.LDR].CheckAllStat(cs.Working))
                                                 {
        ...
        //    //{
        //    //    if(MM.GetManNo() != EN_MANUAL_CYCLE.mcAllHome)
        ...
        //    //    if(MM.GetManNo() != EN_MANUAL_CYCLE.mcAllHome){ //하드웨어 충돌 알람시에 올홈으로 풀수 있다.
