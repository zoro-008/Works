...
namespace SML
{
    ...
    public partial class FormDllMain: Form //UserControl
    {
        ...
        private void tmUpdate_Tick(object sender, EventArgs e)
        {
            ...
            {
                if (m_iPreCrntLevel != SM.FrmPassword.GetLevel()) DispMotr();
        ...
        private void DispMotr()
        {
            ...
            if(SM.FrmPassword.GetLevel() == EN_LEVEL.Master)
            ...
            m_iPreCrntLevel = SM.FrmPassword.GetLevel();
        ...
        {
            ListViewToCSV(lvError, "Util\\Export.csv", true);
