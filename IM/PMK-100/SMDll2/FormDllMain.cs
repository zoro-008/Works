    ...
    public partial class FormDllMain: Form //UserControl
    {
        ...
        private void btCylApply_Click(object sender, EventArgs e)
        {
            ...
            if (tbCylNo.Text != "")
            {
                ...
                SM.CL.Repeat.iDelay = Convert.ToInt32(tbRptDelay.Text);
        ...
        public void SetCntrlPn(Panel _pnBase)
        {
            if (tbCylNo.Text != "")
            {
                ...
                { 
                    case EN_MOVE_DIRECTION.mdLR : if(Properties.Resources.LEFT  != null) btBwd.Image = Properties.Resources.LEFT ;
                    ...
                    case EN_MOVE_DIRECTION.mdRL : if (Properties.Resources.RIGHT != null) btBwd.Image = Properties.Resources.RIGHT;
                    ...
                    case EN_MOVE_DIRECTION.mdBF : if (Properties.Resources.UP != null) btBwd.Image = Properties.Resources.UP;
                    ...
                    case EN_MOVE_DIRECTION.mdFB : if (Properties.Resources.DN != null) btBwd.Image = Properties.Resources.DN;
                    ...
                    case EN_MOVE_DIRECTION.mdUD : if (Properties.Resources.UP != null) btBwd.Image = Properties.Resources.UP;
                                                  if (Properties.Resources.DN != null) btFwd.Image = Properties.Resources.DN;
                    ...
                    case EN_MOVE_DIRECTION.mdDU : if (Properties.Resources.DN != null) btBwd.Image = Properties.Resources.DN;
                                                  if (Properties.Resources.UP != null) btFwd.Image = Properties.Resources.UP;
                    ...
                    case EN_MOVE_DIRECTION.mdCA : if (Properties.Resources.CW  != null) btBwd.Image = Properties.Resources.CW  ;
                    ...
                    case EN_MOVE_DIRECTION.mdAC : if (Properties.Resources.CCW != null) btBwd.Image = Properties.Resources.CCW;
        ...
        public void btBwd_MouseDown(object sender, MouseEventArgs e)
        {
            if (tbCylNo.Text != "")
            {
                ...
                SM.CL.Move(iSelNo, EN_CYLINDER_POS.cpBwd);
            }
        }
        ...
        public void btFwd_MouseDown(object sender, MouseEventArgs e)
        {
            if (tbCylNo.Text != "")
            {
                ...
                Log.Trace(Para.sName, "Clicked");
                SM.CL.Move(iSelNo, EN_CYLINDER_POS.cpFwd);
            }
        }
