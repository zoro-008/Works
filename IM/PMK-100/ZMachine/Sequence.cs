...
namespace Machine
{
    ...
    public sealed class SEQ
    {
        ...
        static public Picker PCK = new Picker();
        ...
        public static void Reset()
        {
         ...
         private static void UpdateButton  ()
         {
             ...
             if (m_iStep == EN_SEQ_STEP.scIdle) InspectLightGrid();
             //Local Var.
             ...
             bool bAirSw     = SM.IO.GetXUp((int)xi.ETC_AirSw  ) || m_bBtnAir   ;
             bool bInitSw    = SM.IO.GetXUp((int)xi.ETC_InitSw )                ;
             ...
             SM.IO.SetY((int)yi.ETC_AirLp    , SM.IO.GetX((int)xi.ETC_AirSw   ) || SM.IO.GetY((int)yi.ETC_MainAirSol));
             SM.IO.SetY((int)yi.ETC_InitLp   , SM.IO.GetX((int)xi.ETC_InitSw  )                                      );
             ...
             if (bStartSw)
             {
                 ...
                 if (m_iSeqStat == EN_SEQ_STAT.ssWorkEnd) Reset();
             }
             ...
             {
                 SM.IO.SetY((int)yi.ETC_MainAirSol , !SM.IO.GetY((int)yi.ETC_MainAirSol )) ;
             }
...
//                                                 SLD.iCleanCntAtWork = 0;
        ...
        public static bool InspectMainAir()
        {
            ...
            if(!SM.IO.GetX((int)xi.ETC_MainAir)) isOk = false ;
        ...
        public static bool  InspectEmergency()
        {
            ...
            //Check Emergency
            if (SM.IO.GetX((int)xi.ETC_EmgSw1) || SM.IO.GetX((int)xi.ETC_EmgSw2))
            {
                SM.MT.EmgStopAll();
        ...
        public static bool  InspectLightGrid()
        {
            ...
            if (!SM.IO.GetX((int)xi.ETC_DoorFt) ||//Front Door Sensor
                !SM.IO.GetX((int)xi.ETC_DoorRt) ||//Front Door Sensor
                !SM.IO.GetX((int)xi.ETC_DoorLt) || //Front Door Sensor
                !SM.IO.GetX((int)xi.ETC_DoorRr)) //Front Door Sensor
                isOk = false;

            SM.IO.SetY((int)yi.ETC_LightOnOff, !isOk);
