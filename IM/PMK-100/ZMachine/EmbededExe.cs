        ...
        static public void CameraInit()
        {
            ...
            if (process.Length > 0)
            {
                ...
                foreach (Process proc in process)
                {
                    ...
                    {
                        CameraProcess = Process.Start("D:\\CS2013Works\\PMK-100\\Bin\\NeptuneReset\\NeptuneReset.exe", "HPS.exe");
                        Thread.Sleep(500);
                    }
                    //    proc.Kill();
            ...
            try
            {
                ...
                CameraProcess = Process.Start("C:\\PTInkMarkingISystem\\InkMarkingInspection\\HPS.exe");//"AmCap.exe");
