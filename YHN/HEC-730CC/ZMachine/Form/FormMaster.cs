    ...
    public partial class FormMaster : Form
    {
        ...
        public void UpdateMstOptn(bool bTable)
        {
            if(bTable)
            {
                ...
                CConfig.ValToCon(cbUseAutoShutDown   , ref OM.MstOptn.bUseAutoShutDown);
                CConfig.ValToCon(tbShutDownTime      , ref OM.MstOptn.sShutDownTimer  );
                ...
                CConfig.ConToVal(cbUseAutoShutDown   , ref OM.MstOptn.bUseAutoShutDown);
                CConfig.ConToVal(tbShutDownTime      , ref OM.MstOptn.sShutDownTimer  );
