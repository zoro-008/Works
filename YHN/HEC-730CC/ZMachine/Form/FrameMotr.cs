    ...
    public partial class FraMotr : Form
    {
        ...
        private void btNeg_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (!OM.MstOptn.bDebugMode)
            {
                ...
                if (m_eId == mi.LPCK_Y) bRet = SEQ.LPCK.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.RPCK_Y) bRet = SEQ.RPCK.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Neg, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
        ...
        private void btPos_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (!OM.MstOptn.bDebugMode)
            {
                ...
                if (m_eId == mi.LPCK_Y) bRet = SEQ.LPCK.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
                if (m_eId == mi.RPCK_Y) bRet = SEQ.RPCK.JogCheckSafe((mi)m_eId, EN_JOG_DIRECTION.Pos, (EN_UNIT_TYPE)Para.iUnitType, Para.dUnit);
