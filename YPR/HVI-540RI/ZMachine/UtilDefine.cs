...
namespace Machine
{
 ...
 //       public const int BPCK      = 11; //바코드 픽커.
    ...
    public enum ci : uint
    {
        ...
        LODR_RngGrpFwBw   =  9 ,   //로더 링 그립퍼 Open/Close
        LODR_GrpRtrCwCCw  = 10 ,   //로더 그립퍼로터리 실린더 
        LODR_PckrRtrCwCCw = 11 ,   //로더 픽커로터리 실린더   1
        LODR_PckrFwBw     = 12 ,   //로더 픽커 실린더.        1 
        VISN_TurnGrpFwBw  = 13 ,   //비전 턴 그립퍼 Open/Close 2
        VISN_TurnRtrCwCCw = 14 ,   //비전 턴 로터리 2
        VISN_FixRtrCwCCw  = 15 ,   //비전 픽 로터리
        VISN_GrpRtrCwCCw  = 16 ,   //비전 그립퍼 로터리 2
        ...
        ULDR_ReGrRtrCwCCw = 23 ,   //언로더 리그립 로터리 3
        ULDR_RngReGrFwBw  = 24 ,   //언로더 링 리그립퍼  3
        ULDR_OutPshrFwBw  = 25 ,   //언로더 아웃 푸셔
        ULDR_RngGrpFwBw   = 26 ,   //언로더 링 그립퍼 4
        ULDR_GrpRtrCwCCw  = 27 ,   //언로더 그립퍼 로터리 4
        ULDR_GrpFwBw      = 28 ,   //언로더 그립퍼 Open/Close 4
        MAX_ACTR
    };
    public enum ax : uint
    {
    ...
    public enum pv : uint
    {
        ...
        TBLE_TTbleWait             = 0,
        TBLE_TTbleWorkPitch           ,
        TBLE_TTbleBarcRead            , //1.0.1.4 바코드 읽는 포지션(옵셋)
        MAX_PSTN_MOTR2                ,
