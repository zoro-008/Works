...
namespace Machine
{
    public partial class FormOperation : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (SEQ.BarCodeReader.GetBarcode() != "") lbBarcText.Text = SEQ.BarCodeReader.GetBarcode();
            if (SEQ.BarCodeReader.GetGrade  () != "") lbBarcApndGrade.Text = SEQ.BarCodeReader.GetGrade();
        ...
        {
            SEQ.BarCodeReader.BarcodeOn();
            //SEQ.BarCodeReader.CycleTest();
        }

        private void btBarcCnct_Click(object sender, EventArgs e)
        {
            if (!SEQ.BarCodeReader.GetReady())
            {
                SEQ.BarCodeReader.ConnectToServer();
                Log.ShowMessage("SR_1000", "Barcode Connecting");
            }
        }
