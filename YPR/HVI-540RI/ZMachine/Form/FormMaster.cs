...
namespace Machine
{
    public partial class FormMaster : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (SEQ.BarCodeReader.GetBarcode() != "") lvRcvdData.Text = SEQ.BarCodeReader.GetBarcode();
            //else                                      lvRcvdData.Text = "";
            //label12.Text = SEQ.BarCodeReader.GetInputBarcode();
            if (SEQ.BarCodeReader.GetBarcode() == "ERROR") label12.Text = "bRet1";
            if (SEQ.BarCodeReader.GetBarcode() != "ERROR" && SEQ.BarCodeReader.GetBarcode() != SEQ.BarCodeReader.GetInputBarcode()) label12.Text = "bRet2";
        ...
        {
            label12.Text = SEQ.BarCodeReader.GetInputBarcode();
            //SEQ.BarCodeReader.BarcodeReading();
            ////SEQ.BarCodeReader.TestDataReceived();
            //SEQ.BarCodeReader.CycleReading();
            //SEQ.TTBL.iWorkCount = 1;
        }
    }
}
