    ...
    public partial class FormOption : Form
    {
        ...
        {                                                                                   
            if (_bToTable == true) 
            {
                ...
                CConfig.ValToCon(cbPaintSkip      , ref OM.CmnOptn.bPaintSkip     );
                ...
                CConfig.ValToCon(cbStopBarcRead   , ref OM.CmnOptn.bStopBarcRead  );

                //Ver 2019.9.9.1
                //비전 턴 로터리 실린더 테스트 모드 추가
                //기존에 VisnZone -> CycleWork에서 비전 스킵 옵션 체크 시 턴 로터리 실린더를
                //무조건 돌리도록 하던 것을 한 방향으로만 놓도록 수정해달라고 하여 해당 실린더
                //테스트 용으로 옵션을 따로 둠.
                CConfig.ValToCon(cbVisnTurnCylTest, ref OM.CmnOptn.bVisnTurnCylTest); 
            ...
            else 
            {
                ...
                CConfig.ConToVal(cbPaintSkip      , ref OM.CmnOptn.bPaintSkip     );
                ...
                CConfig.ConToVal(cbStopBarcRead   , ref OM.CmnOptn.bStopBarcRead  );
                ...
                //무조건 돌리도록 하던 것을 한 방향으로만 놓도록 수정해달라고 하여 해당 실린더
                //테스트 용으로 옵션을 따로 둠.
                CConfig.ConToVal(cbVisnTurnCylTest, ref OM.CmnOptn.bVisnTurnCylTest);
