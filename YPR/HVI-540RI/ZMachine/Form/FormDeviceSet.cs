...
namespace Machine
{
    public partial class FormDeviceSet : Form
    {
        ...
        public void PstnDisp()
        {
            ...
            PM.SetProp((uint)mi.TBLE_TTble, (uint)pv.TBLE_TTbleBarcRead    , "BarcodeRead     ", true , false, true   );
        ...
        public void UpdateDevInfo(bool bToTable)
        {
            if (bToTable)
            {
                ...
                CConfig.ValToCon(tbNozzelXPitch     , ref OM.DevInfo.dNozzelXPitch   );
                CConfig.ValToCon(tbNozzelDelay      , ref OM.DevInfo.iNozzelDelay    );
                CConfig.ValToCon(tbNozzelRptCnt     , ref OM.DevInfo.iNozzelRptCnt   );
                CConfig.ValToCon(tbPaintColorNo     , ref OM.DevInfo.iPaintColorNo   );

                CConfig.ValToCon(tbBarcodeReadData1  , ref OM.DevInfo.sBarcodeReadData1);
                CConfig.ValToCon(tbBarcodeReadData2  , ref OM.DevInfo.sBarcodeReadData2);
                CConfig.ValToCon(cbUseYearMonth1     , ref OM.DevInfo.bUseYearMonth1   );
                CConfig.ValToCon(cbUseYearMonth2     , ref OM.DevInfo.bUseYearMonth2   );
                CConfig.ValToCon(nBarcodeErrCnt      , ref OM.DevInfo.iBarcodeErrCnt   );

                if (OM.DevInfo.iPaintColorNo == 0) rbPaintNo1.Select();
                if (OM.DevInfo.iPaintColorNo == 1) rbPaintNo2.Select();
                if (OM.DevInfo.iPaintColorNo == 2) rbPaintNo3.Select();
                if (OM.DevInfo.iPaintColorNo == 3) rbPaintNo4.Select();
                if (OM.DevInfo.iPaintColorNo == 4) rbPaintNo5.Select();
            ...
            else 
            {
                ...
                CConfig.ConToVal(tbNozzelXPitch     , ref OM.DevInfo.dNozzelXPitch   );
                CConfig.ConToVal(tbNozzelDelay      , ref OM.DevInfo.iNozzelDelay    );
                CConfig.ConToVal(tbNozzelRptCnt     , ref OM.DevInfo.iNozzelRptCnt   );
                CConfig.ConToVal(tbPaintColorNo     , ref OM.DevInfo.iPaintColorNo   );

                CConfig.ConToVal(tbBarcodeReadData1  , ref OM.DevInfo.sBarcodeReadData1);
                CConfig.ConToVal(tbBarcodeReadData2  , ref OM.DevInfo.sBarcodeReadData2);
                CConfig.ConToVal(cbUseYearMonth1     , ref OM.DevInfo.bUseYearMonth1   );
                CConfig.ConToVal(cbUseYearMonth2     , ref OM.DevInfo.bUseYearMonth2   );
                CConfig.ConToVal(nBarcodeErrCnt      , ref OM.DevInfo.iBarcodeErrCnt   );
        ...
        private void rbPaintNo_Click(object sender, EventArgs e)
        {
            ...
            switch (iUnit)
            {
                default: OM.DevInfo.iPaintColorNo = 0 ; tbPaintColorNo.Text = "0"; break;
                case 1 : OM.DevInfo.iPaintColorNo = 1 ; tbPaintColorNo.Text = "1"; break;
                case 2 : OM.DevInfo.iPaintColorNo = 2 ; tbPaintColorNo.Text = "2"; break;
                case 3 : OM.DevInfo.iPaintColorNo = 3 ; tbPaintColorNo.Text = "3"; break;
                case 4 : OM.DevInfo.iPaintColorNo = 4 ; tbPaintColorNo.Text = "4"; break;
            }
