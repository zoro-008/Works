    ...
    public class VisionZone : Part
    {
        ...
        public bool CycleWork()
        {
            ...
            switch (Step.iCycle)
            {
                ...
                case 20:
                    ...
                    if (OM.CmnOptn.bVisnSkip){
                        if (OM.CmnOptn.bVisnTurnCylTest)//Ver 2019.9.9.1 비전스킵에서 턴 로터리 실린더 계속 돌리면서 내려놓을 때
                        {
                            Step.iCycle = 24;
                            return false;
                        }
                        else                            //Ver 2019.9.9.1 비전스킵에서 한 방향으로만 내려놓을 때
                        {
                            Step.iCycle = 30;
                            return false;
                        }
                ...
                //위에서 씀
                //Ver 2019.9.9.1
                //Vision Skip에서 자재 한방향으로만 내려놓을 때 스텝
                case 30:
                    MoveMotr(mi.VISN_ZGrpr, pv.VISN_ZGrprWait);
                    Step.iCycle++;
                    return false;
        ...
        public bool CycleReverse()
        {
            ...
            switch (Step.iCycle)
            {
                ...
                case 16:
                    if (!MT_GetStopInpos(mi.VISN_ZGrpr)) return false;
                    CL_Move(ci.VISN_FixRtrCwCCw, fb.Fwd);
                    Step.iCycle++;
                    return false;
