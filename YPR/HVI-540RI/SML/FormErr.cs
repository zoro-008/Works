...
namespace SML
{
    public partial class FormErr : Form
    {
        ...
        public FormErr()
        {
            ...
            pnErrPic.Visible = SM.ER._bUseErrPic ;
            pnErr.Visible    = SM.ER._bUseErrPic ;

            int iWidthHalfSize  = this.Width  / 2;
            int iHeightHalfSize = this.Height / 2;

            if(!SM.ER._bUseErrPic)
            {
        ...
        private void pbErr_Paint(object sender, PaintEventArgs e)
        {
            ...
            int iImgErrWidth  = SM.ER.GetPanelSize().iWidth ;
            int iImgErrHeight = SM.ER.GetPanelSize().iHeight;
