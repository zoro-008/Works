...
{    
    ...
    {   
        ...
        [CategoryAttribute("GentryPara" ), DisplayNameAttribute("Gantry Enable"        )]public bool          bGantryEnable  {get; set;} 
        [CategoryAttribute("GentryPara" ), DisplayNameAttribute("Gantry SubPhyAdd"     )]public int           iGantrySubAdd  {get; set;} 
        [CategoryAttribute("GentryPara" ), DisplayNameAttribute("Gantry Mathod"        )]public GANTRY_MATHOD eGantryMathod  {get; set;} 
        [CategoryAttribute("GentryPara" ), DisplayNameAttribute("Gantry Offset"        )]public double        dGantryOffset  {get; set;} 
        [CategoryAttribute("GentryPara" ), DisplayNameAttribute("Gantry Offset Range"  )]public double        dGantryOfsRange{get; set;} 
