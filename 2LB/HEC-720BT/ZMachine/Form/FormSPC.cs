...
namespace Machine
{
    public partial class FormSPC : Form
    {
        ...
        public FormSPC(Panel _pnBase)
        {
            ...
            //string sDate = lvLotDate.Items[0].SubItems[1].ToString();
        ...
        {
            if (lvLotDate.SelectedIndices.Count <= 0) return;

            int iItemRow = lvLotDate.SelectedIndices[0];
            string sDate = lvLotDate.Items[iItemRow].SubItems[1].Text;
