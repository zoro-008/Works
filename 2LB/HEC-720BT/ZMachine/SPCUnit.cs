    ...
    public class LotData
    {
        ...
        public void Update(EN_SEQ_STAT Stat)
        {
            ...
            if (SEQ._bRun)
            {
                ...
                {
                    if (!SML.IO.GetX((int)xi.IDX_Detect1)) m_tData.iWorkCnt += 1;
                    if (!SML.IO.GetX((int)xi.IDX_Detect2)) m_tData.iWorkCnt += 1;
                    if (!SML.IO.GetX((int)xi.IDX_Detect3)) m_tData.iWorkCnt += 1;
                    if (!SML.IO.GetX((int)xi.IDX_Detect4)) m_tData.iWorkCnt += 1;
                    if (!SML.IO.GetX((int)xi.IDX_Detect5)) m_tData.iWorkCnt += 1;
        ...
        public void DispLotInfo(ListView _lvLotInfo) //오퍼레이션 창용.
        {
            ...
            _lvLotInfo.Items[2].SubItems[0].Text = "UPH      ";
    ...
    public class DayData
    {
        ...
        public void Update(/*string _sCrntLotNo,*/ EN_SEQ_STAT Stat)
        {
            ...
            if (SEQ._bRun)
            {
                ...
                {
                    if (!SM.IO_GetX(xi.IDX_Detect1)) m_tData.iWorkCnt += 1;
                    if (!SM.IO_GetX(xi.IDX_Detect2)) m_tData.iWorkCnt += 1;
                    if (!SM.IO_GetX(xi.IDX_Detect3)) m_tData.iWorkCnt += 1;
                    if (!SM.IO_GetX(xi.IDX_Detect4)) m_tData.iWorkCnt += 1;
                    if (!SM.IO_GetX(xi.IDX_Detect5)) m_tData.iWorkCnt += 1;
