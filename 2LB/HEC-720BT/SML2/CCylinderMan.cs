...
namespace SML2
{
    public class CCylinder
    {
        ...
        {            
            ...
            if(bVtrlFwdX) Stat.eCmdPos = EN_CYLINDER_POS.Fwd ;
            if(bVtrlBwdX) Stat.eCmdPos = EN_CYLINDER_POS.Bwd ;
        ...
        public void Update()
        {
            ...
            if(bDelayedFwd) Stat.eActPos = EN_CYLINDER_POS.Fwd;
            if(bDelayedBwd) Stat.eActPos = EN_CYLINDER_POS.Bwd;
            ...
            if ( bVtrlFwdX && !bVtrlBwdX) Stat.eCmdPos = EN_CYLINDER_POS.Fwd;
            if (!bVtrlFwdX &&  bVtrlBwdX) Stat.eCmdPos = EN_CYLINDER_POS.Bwd;
    ...
    public class CCylinderMan//========================================================================================================================
    {
        ...
        public void GoRpt(int _iDelay , int _iActr1No , int _iActr2No = -1)
        {
            ...
            if (GetCmd(_iActr1No) == EN_CYLINDER_POS.Fwd && GetCmd(_iActr2No) == EN_CYLINDER_POS.Fwd) Repeat.bRepeatFwd = true;
            if (GetCmd(_iActr1No) == EN_CYLINDER_POS.Bwd && GetCmd(_iActr2No) == EN_CYLINDER_POS.Bwd) Repeat.bRepeatFwd = false;
        ...
        public void RptActr ()
        {
            ...
            { //실린더 1개 맞출때
                ...
                {
                    Move(Repeat.iFrstActr, EN_CYLINDER_POS.Bwd);
                    Repeat.DelayRepeat.Clear();
                ...
                if (Repeat.DelayRepeat.OnDelay(true, Repeat.iDelay) && !Repeat.bRepeatFwd)
                {
                    Move(Repeat.iFrstActr, EN_CYLINDER_POS.Fwd);
                    Repeat.DelayRepeat.Clear();
            ...
            {                      //실린더 2개 같이 맞출때
                ...
                {
                    Move(Repeat.iFrstActr, EN_CYLINDER_POS.Bwd);
                    Move(Repeat.iScndActr, EN_CYLINDER_POS.Bwd);
                    Repeat.DelayRepeat.Clear();
                    Repeat.bRepeatFwd = false;
                }
                //if (Repeat.DelayRepeat.OnDelay(GetCmd(Repeat.iFrstActr) == EN_CYLINDER_POS.cpBwd, Repeat.iDelay))
                ...
                {
                    Move(Repeat.iFrstActr, EN_CYLINDER_POS.Fwd);
                    Move(Repeat.iScndActr, EN_CYLINDER_POS.Fwd);
                    Repeat.DelayRepeat.Clear();
                    Repeat.bRepeatFwd = true;
                }
            }
        ...
        public void DisplayStatus(int _iActrNo , Label _lbFwdStat , Label _lbBwdStat , Label _lbAlarm)
        {
            ...
            //Display.
            if (m_aCylinder[_iActrNo].Complete(EN_CYLINDER_POS.Fwd)) _lbFwdStat .BackColor = Color.Lime;
            else                                                       _lbFwdStat .BackColor = Color.Gray;
            if (m_aCylinder[_iActrNo].Complete(EN_CYLINDER_POS.Bwd)) _lbBwdStat .BackColor = Color.Lime;
