...
namespace Machine
{
    ...
    public class CLot : DataHandler<TLotData>
    {
        ...
        public void DispLotInfo(ListView _lvLotInfo) //오퍼레이션 창용.
        {
            ...
            //Device
            _lvLotInfo.Items[0].SubItems[0].Text = "Device";
            _lvLotInfo.Items[0].SubItems[1].Text = Data.Device;

            //LotId
            _lvLotInfo.Items[1].SubItems[0].Text = "LotNo";
            _lvLotInfo.Items[1].SubItems[1].Text = Data.LotNo;

            //WorkCnt
            _lvLotInfo.Items[2].SubItems[0].Text = "WorkCnt  ";
            _lvLotInfo.Items[2].SubItems[1].Text = Data.WorkCnt.ToString();

            //UPH
            //sTemp = string.Format("{0:0.0}", OM.EqpStat.dUPH);
            //_lvLotInfo.Items[3].SubItems[0].Text = "UPH ";
            //_lvLotInfo.Items[3].SubItems[1].Text = sTemp;

            //CutTime
            sTemp = string.Format("{0:0.00}", OM.EqpStat.dCutTime);
            _lvLotInfo.Items[3].SubItems[0].Text = "Cut time ";
            _lvLotInfo.Items[3].SubItems[1].Text = sTemp;
            ...
            _lvLotInfo.Items[5].SubItems[0].Text = "Work time ";
