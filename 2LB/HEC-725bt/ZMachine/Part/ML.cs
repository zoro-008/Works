...
namespace Machine
{
    public class ML
    {
        ...
        static public void         MT_JogP            (mi _eMotrNo, double _dVel = 0, double _dAcc = 0, double _dDec = 0)  { SM.MT.JogP ((int)_eMotrNo,_dVel,_dAcc,_dDec)       ;}
        static public void         MT_JogN            (mi _eMotrNo, double _dVel = 0, double _dAcc = 0, double _dDec = 0)  { SM.MT.JogN ((int)_eMotrNo,_dVel,_dAcc,_dDec)       ;}
