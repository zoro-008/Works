...
namespace SML
{
    ...
    public partial class FormDllMain: Form //UserControl
    {
        ...
        private void lbHomeDone_Click(object sender, EventArgs e)
        {
        ...
        {
            if (Log.ShowMessageModal("Confirm", "Do you want chage homedone flag?") != DialogResult.Yes) return;
            //Log.Trace("Program End", ti.Sts);

            string sText = "HomeDone Change";
            Log.Trace(sFormText + sText + " Button Clicked", ti.Frm);
