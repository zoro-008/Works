...
{    
    ...
    public class CMotor:IMotor
    {
        ...
        public void ApplyPara(double _dPulsePerUnit)
        {
            ...
            //변태같지만 이런식으로 같은 함수로 레벨 세팅과 사용여부 같이 세팅 한데 -_-;
        ...
        public void Update()
        {
            ...
            //if (MotionStat.bInPosSgnl != bTemp)
            //{
            //    Log.ShowMessage("Motor", "Diffeant");
            //}

            //CAXM.AxmStatusReadMotion(Para.iPhysicalNo, ref uiInMotion);
            //CAXM.AxmStatusReadInMotion(Para.iPhysicalNo, ref uiInMotion);
            //MotionStat.bInPosSgnl = uiInMotion == 0;
            //MotionStat.bInPosSgnl = ((uiInMotion >> 0) & 0x01) != 0x01;
